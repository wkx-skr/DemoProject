...
import com.datablau.gateway.filter.TenantFilter;
...
public class SecurityConfig {
    ...
    public SecurityWebFilterChain springSecurityFilterChain(ServerHttpSecurity http) {
        SecurityWebFilterChain chain = http
            .addFilterBefore(new TenantFilter(), SecurityWebFiltersOrder.REACTOR_CONTEXT)
            .addFilterBefore(new EntTokenFilter(dataAgentIgnoreUrls, tokenService, userService, reactiveSessionRepository), SecurityWebFiltersOrder.REACTOR_CONTEXT)
            .formLogin()
            .loginPage(loginUrls)
            // 登录成功handler
