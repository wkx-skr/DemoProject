package com.datablau.archy.server.app;
...
@SpringBootApplication(
        scanBasePackages = {"com.datablau.archy"},
        exclude = {
...
public class ArchyApplication extends SpringBootServletInitializer {

    private static final Logger logger = LoggerFactory.getLogger(ArchyApplication.class);
    ...
    protected SpringApplicationBuilder configure(SpringApplicationBuilder builder) {
        ...
        return builder.sources(ArchyApplication.class);
    }

    public static void main(String[] args) throws Exception {
        extractFilesToPath("classpath:/resources/**", "resources");
//        String rootFolder = ShareKit.getCurrentServicePath(ArchyApplication.class);
//        System.setProperty("logging.file.path", rootFolder + "logs");
        SpringApplication.run(ArchyApplication.class);
    }

    private static void extractFilesToPath(String classPathFolder, String targetFolder) throws Exception {
        URL baseUrl = ArchyApplication.class.getProtectionDomain().getCodeSource().getLocation();
        ...
        PathMatchingResourcePatternResolver resolver = new PathMatchingResourcePatternResolver(ArchyApplication.class.getClassLoader());
