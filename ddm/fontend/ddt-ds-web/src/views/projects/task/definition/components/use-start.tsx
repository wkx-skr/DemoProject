...
export const useStart = (
  ...
  const getStartParamsList = (code: number, taskCode: number) => {
    ...
    //   return
    // }
    variables.startForm.savepoint = null
    ...
    querysavepointList(variables.startState.projectCode, taskCode).then(
      (res: any) => {
        if (res.length > 0) {
          variables.startState.savepointList = res.map((item: any) => ({
