...
const login = defineComponent({
  ...
  render() {
    ...
    if (window.self !== window.top) {
      containerClass = 'containerBlack'
    } else {
      containerClass = 'container'
    }
    console.log(window.self !== window.top, 'pp', containerClass, styles)
    return (
      <div class={styles[containerClass]}>
        ...
        <div class={styles['login-model']}>
          <p class={containerClass === 'container' ? 'tip-p' : 'tip-p-black'}>
            由于调度系统session过期或者您的账号在其他地方登陆，请重新登陆
          </p>
          ...
          <div class={styles['form-model']}>
            <NForm rules={this.rules} ref='loginFormRef'>
              <NFormItem
                ...
                label-style={{
                  color: containerClass === 'container' ? 'black' : '#bbb'
                }}
                path='userName'
              >
                <NInput
            ...
            <NButton
              class={containerClass === 'container' ? 'btn-login' : 'blackbtn'}
              round
              type='info'
              disabled={
