...
export default defineComponent({
  ...
  setup(props, ctx) {
    ...
    const monacoEditorThemeRef = ref(themeStore.darkTheme ? 'GreyTheme' : 'vs')  // vs-dark
    const editorRef = ref()
    ...
    const initMonacoEditor = () => {
      ...
      if (dom) {
        ...
        editor = monaco.editor.create(dom, {
          ...props.options,
          readOnly: true,// formItem.mergedDisabledRef.value || props.options?.readOnly,
