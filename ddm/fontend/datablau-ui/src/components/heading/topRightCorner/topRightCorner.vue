<template>
  <div class="box top-right-corner-vue">
    <div style="display: inline-block;height: 50px;position: relative; top: -8px;vertical-align: top">
      <slot></slot>
    </div>
...
<!--    <datablau-button
    ...
    <el-tooltip :content="$t('common.task.title')" :hide-after="1000" effect="dark">
      <el-popover
        placement="right"
        width="600"
        trigger="manual"
      ...
      >
        <div style="padding-left: 12px">
          ...
          <datablau-tabs
            ...
            class="task-tabs"
          >
            <el-tab-pane :label="$t('common.task.importTask')" name="import"></el-tab-pane>
            <el-tab-pane :label="$t('common.task.exportTask')" name="export"></el-tab-pane>
            <el-tab-pane :label="$t('common.task.explorationTask')" name="profiling"></el-tab-pane>
            <el-tab-pane :label="$t('common.task.otherTasks')" name="other"></el-tab-pane>
          </datablau-tabs>
          <div
            style="
              width: 100%;
