...
const directory = {
        ...
        dam: {
            ...
            pages: {
                ...
                "$t('common.page.systemManage')": {
                    ...
                    "$t('common.page.logManagement')": ["devLogs"]
                },
            }
        },
        ddm: {
    ...
    iconMap: {
        "$t('common.page.dataResource')": 'icon-menu-cjgl',
    ...
    pagesMap: {
        ...
        glossary: {
            ...
            appName: "domain-app",
            licenseRequired: ["FE_DOMAIN"],
            accessRequired: ["DICTIONARY_VIEW"],
        },
        dataStandardField: {
        ...
        domainStandard: {
            ...
            appName: "domain-app",
            licenseRequired: ["FE_DOMAIN"],
            accessRequired: ["DATA_STANDARD_FIELD_MANAGE", "DATA_STANDARD_FIELD_VIEW"],
        },
        index: {
            name: "index",
        ...
        dataQualityRules: {
            ...
            appName: "base-app",
            licenseRequired: ["FE_QUALITY"],
            accessRequired: ["QUALITY_BUSINESS_RULE_VIEW_MY","QUALITY_BUSINESS_RULE_VIEW_ALL"],
        },
        qualityRule: {
            ...
            appName: "base-app",
            licenseRequired: ["FE_QUALITY"],
            accessRequired: ["QUALITY_TECHNICAL_REGULATION_VIEW_MY", "QUALITY_TECHNICAL_REGULATION_VIEW_ALL"],
        },
        qualityExamineJob: {
            ...
            appName: "base-app",
            licenseRequired: ["FE_QUALITY"],
            accessRequired: ["QUALITY_CHECK_TASK_VIEW_MY", "QUALITY_CHECK_TASK_VIEW_ALL"],
        },
        dataQualityRepairJob: {
            ...
            appName: "base-app",
            licenseRequired: ["FE_QUALITY"],
            accessRequired: ["QUALITY_ISSUE_LIST_VIEW_MY", "QUALITY_ISSUE_LIST_VIEW_ALL"],
        },
        dataQualityCheck: {
            ...
            appName: "base-app",
            licenseRequired: ["FE_QUALITY"],
            accessRequired: ["QUALITY_PROBLEM_CHECK_VIEW_MY", "QUALITY_PROBLEM_CHECK_VIEW_ALL"],
        },
        knowledgebase: {
