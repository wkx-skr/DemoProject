...
export default {
  ...
  mounted () {
    this.uploadUrl = `${this.$domains}/requirementmanagement/file/upload`
  ...
  methods: {
    ...
    downloadDoc (fileId) {
      const url = this.$domains + 'requirementmanagement/file/download?fileId=' + fileId
    ...
    getDocumentsDetail () {
      ...
      if (fileIds) {
        ...
        this.$http
          .get(this.$domains + 'requirementmanagement/file?fileIds=' + fileIds)
          .then(res => {
