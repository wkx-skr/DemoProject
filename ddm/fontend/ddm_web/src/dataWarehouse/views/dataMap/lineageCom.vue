<template>
  <div class="rawBox">
    ...
    <div class="con">
      <div class="button-left" v-if="hoverErrorMsg === ''"  style="display: inline-block;padding-top: 6px;">
      ...
      <div v-if="hoverErrorMsg !== ''" class="errorMessage">
        <div class="errorImg" style="position: absolute;top: 30px;">
          <img src="../sqlEditor/errorimg.png">
        </div>
  ...
  methods: {
    ...
    refreshLineage () {
      ...
      this.getDataPromise = new Promise((resolve, reject) => {
        ...
        let url = `${HTTP.$damServerUrl}lineage/${this.propertiesFileData.lineageId}`
        self.$http.get(url)
          .then(res => {
            this.loadingGraph = false
            resolve(res)
