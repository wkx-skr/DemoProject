...
export default {
  ...
  methods: {
    ...
    exportSelection () {
      const url = `${this.$domains}metricManagement/exportMetric`
    ...
    getNameByUserName (users) {
      users && users.length && UserInformationService.getUsernames(users).then(map => {
    ...
    downloadTemplate () {
      const url = `${this.$domains}metricManagement/downloadMetricTemplate?categoryId=${
    ...
    deleteStandard (selectionFromOtherFunction) {
      ...
      this.$DatablauCofirm(
        ...
        .then(() => {
          ...
          postMethod({
            method: 'post',
            requestUrl: `${this.$domains}/domains/domain/deleteDomainByIds`,
      ...
      selection.forEach(item => {
        ...
        promises.push(
          new Promise((resolve, reject) => {
            this.$http
              .post(`${this.$domains}domains/domain/updateDomain`, item)
              .then(res => {
