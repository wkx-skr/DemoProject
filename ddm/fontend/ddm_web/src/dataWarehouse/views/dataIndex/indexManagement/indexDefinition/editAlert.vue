...
export default {
  ...
  methods: {
    ...
    getAlert (row) {
      // this.$http
      //   .post(
      //     `${this.$domains}metricManagement/metricWarning/get?metricWarningId=${row.id}`
      //   )
      //   .then(res => {
    ...
    save () {
      let url
      if (this.editMode) {
        url = `${this.$domains}metricManagement/metricWarning/update?metricWarning=${this.formData.id}`
      } else {
        url = `${this.$domains}metricManagement/metricWarning/add`
      }
      this.$http
        .post(url, {
          id: this.formData.id,
