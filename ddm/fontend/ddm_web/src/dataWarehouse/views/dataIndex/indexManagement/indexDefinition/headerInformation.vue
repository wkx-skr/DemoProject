...
export default {
  ...
  methods: {
    getVisit () {
      this.$http
        .get(
          `${this.$damUrl}/service/browse/click/count/${this.details.domainId}/80010066`
        )
        .then(res => {
          this.visit = res.data
        })
    ...
    getCollectionNum () {
      ...
      this.$http.post(this.$baseUrl + '/service/favor/count', params).then(res => {
    ...
    toggleCollecStatus () {
      ...
      if (this.hasCollected) {
        this.$http.post(`${HTTP.DAM_BASE_URL}/service/favor/`, obj)
          .then(res => {
            succesedCallback(res.data)
          })
          .catch(e => {
            failureCallback(e)
          })
        ...
        this.favId &&
        this.$http.delete(`${HTTP.DAM_BASE_URL}/service/favor/`, this.favId)
          .then(res => {
            succesedCallback(res.data)
          })
          .catch(e => {
