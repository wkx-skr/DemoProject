    ...
    >
      <div style="padding: 10px 20px">
        <datablau-form
          ...
          :model="formData"
        >
        <datablau-detail-subtitle :title="$t('domain.domain.baseInfo')" mt="20px"></datablau-detail-subtitle>
          <div>
            <el-form-item
          ...
          <div
            ...
            "
          >
          <datablau-detail-subtitle title="指标构成" mt="20px"></datablau-detail-subtitle>
          ...
          <datablau-detail-subtitle :title="$t('domain.domain.businessInfo')" mt="20px"></datablau-detail-subtitle>
          <div>
            <el-form-item
          ...
          <datablau-detail-subtitle :title="$t('domain.domain.techInfo')" mt="20px"></datablau-detail-subtitle>
          <div>
            <el-form-item
              label="信息类型"
              prop="rangeType"
          ...
          >
          <datablau-detail-subtitle :title="$t('domain.domain.manageInfo')" mt="20px"></datablau-detail-subtitle>
          ...
          <div>
            ...
            >
              <datablau-input
                ...
                @clear="formData.descriptionDepartment = null"
                style="display: inline-block; width: 437px"
                class="no-dropdown-icon"
              ></datablau-input>
              <datablau-button
