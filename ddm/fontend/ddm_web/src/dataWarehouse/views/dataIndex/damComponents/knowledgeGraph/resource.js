export default {
  ...
  mounted () {
    if (this.app === 'archy') {
      this.$set(this.typeNameArr, 80010077, '系统域')
      this.$set(this.typeNameArr, 80100073, '业务对象')
      this.$set(this.typeNameArr, 80010076, '业务对象主题目录')
      this.$set(this.typeNameArr, 80010001, '模型')
      this.$set(this.typeNameArr, 80000004, '实体')
      this.$set(this.typeNameArr, 80000005, '属性')
      this.$set(this.typeNameArr, 82800012, '应用系统')
    }
  }
}
