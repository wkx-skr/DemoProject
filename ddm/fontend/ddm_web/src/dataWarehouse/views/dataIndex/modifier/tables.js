...
import setUdp from '@/dataWarehouse/views/dataIndex/indexManagement/dimensionDefinition/setUdp'
...
export default {
  ...
  methods: {
    ...
    getValueUdp () {
      this.$http
        .post(`${this.$domains}dimension/udp/get?category=${String(this.ldmType)}`)
        .then(res => {
