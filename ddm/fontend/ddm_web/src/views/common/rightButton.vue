<template>
  <div class="page-heading">
    <div class="right">
      <div class="search-outer" :class="{'show-search-input': showSearchInput}"
           :style="{'max-width': windowWidth + 'px'}" @click="searchInputShow">
      ...
      <datablau-tooltip :content="$v.about.versionInfo" :hide-after="1000" effect="light">
        <i class="iconfont icon-banben" style="color: #999;font-size: 16px;padding-right: 16px;cursor: pointer;" @click="showInfo"></i>
      </datablau-tooltip>
      <span class="downlod-ddm">
        <datablau-tooltip :content="$store.state.$v.header.downloadDDM" :hide-after="1000" effect="light">
          <span class="down-btn" @click="downloadDDM"><i class="iconfont icon-download" style="color: #999;font-size: 16px;"></i></span>
        </datablau-tooltip>
      </span>
      <new-model></new-model>
      <span class="downlod-ddm" style="margin-right: 8px;">
        <datablau-tooltip :content="$v.pageHead.launch" :hide-after="1000" effect="light">
          <div class="sign-in-ddm-wrapper">
            <span class="down-btn" @click="signInDDM"><i class="img-workbench"></i>&nbsp;{{ $v.pageHead.launch }}</span>
          </div>
        </datablau-tooltip>
      </span>
      <!--<el-dropdown
