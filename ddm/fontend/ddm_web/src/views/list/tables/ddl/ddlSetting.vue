<template>
  <div>
    ...
    <datablau-button type="important" size="small" @click="submit">{{$store.state.$v.dataEntity.ok}}</datablau-button>
    <datablau-button type="secondary" size="small" @click="close">{{$store.state.$v.dataEntity.cancel}}</datablau-button>
  </div>
</template>
<script>
