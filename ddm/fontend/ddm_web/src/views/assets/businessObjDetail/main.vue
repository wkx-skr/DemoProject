  ...
  <div class="businessObj-detail-wrapper">
    ...
    <div class="content-panel-wrapper">
      ...
      <div v-show="panel==='consanguinity'" class="lineage-container">
        <model-lineage v-if="panel==='consanguinity'" :modelId="id"></model-lineage>
      </div>
...
export default {
  data () {
    return {
      ...
      breadcrumbData: [{ name: '业务对象', operate: '/main/businessObj' }],
      diagrams: null,
      diagramId: null,
      diagramName: null,
  ...
  methods: {
    ...
    getInfo () {
      this.$http.get(this.$url + '/service/archy/object/object/' + this.id).then(res => {
        this.info = res.data
        this.title = this.info.name
        let currentTheme = this.themeList.find(v => v.id === res.data.subjectId)
    ...
    getModelInfo () {
      this.$http.post(this.$url + '/service/archy/object/object/info/' + this.id, {
