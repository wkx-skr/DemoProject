  ...
  methods: {
    ...
    changeUserTypeConfirm (val, row) {
      ...
      if (this.manageType === 'model') {
        ...
        editUserPromise = HTTP.updateCategoryPermissionLayerTable({
    ...
    handleDeletePermission (row) {
      ...
      if (this.manageType === 'model') {
        ...
        deletePromise = HTTP.updateCategoryPermissionLayerTable({
          categoryId: this.categoryId,
          tableId: this.tableId,
          applyToChildren: this.applyToChildren,
          applyToModel: this.applyToModel,
    ...
    addUsers () {
      ...
      if (this.manageType === 'model') {
        ...
        addUserPromise = HTTP.updateCategoryPermissionLayerTable({
          categoryId: this.categoryId,
          tableId: this.tableId,
          applyToChildren: this.applyToChildren,
          applyToModel: this.applyToModel,
    ...
    getModelPermissionUsers () {
      ...
      if (this.manageType === 'model') {
        ...
        getUserPromise = HTTP.getCategoryPermissionLayerTable(this.tableId, this.categoryId)
      }
      getUserPromise
        .then(res => {
