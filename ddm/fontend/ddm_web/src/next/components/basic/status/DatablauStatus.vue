...
export default {
  ...
  data() {
    return {
      typeObj: {
        1: ['#5dc4c0', 'rgba(93, 196, 192, 0.1)'],
        2: ['#409eff', 'rgba(64, 158, 255, 0.1)'],
        3: ['#e6ad00', 'rgba(230, 173, 0, 0.1)'],
        4: ['#66bf16', 'rgba(102, 191, 22, 0.1)'],
        5: ['#ff4b53', 'rgba(255, 75, 83, 0.1)'],
        6: ['#BB6CF9', 'rgba(187, 108, 249, 0.1)'],
        7: ['#AFB4BF', 'rgba(153, 153, 153, 0.1)'],
        ...
        moxingbaogao: ['#4C6CB3', 'rgba(76, 108, 179, 0.1)'],
        yewuduixiang: ['#745399', 'rgba(116, 83, 153, 0.1)'],
        yewulingyu: ['#A25768', 'rgba(162, 87, 104, 0.1)'],
        shujmoxingpingshenshenqing: ['#0095D9', 'rgba(0, 149, 217, 0.1)'],
