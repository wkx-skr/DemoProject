<template>
  <div class="datablau-input">
    ...
    <div class="completeSearch" :class="{ disabledGrey: disabledGrey,'small-datablau-input': smallDatablauInput,'black-theme': themeBlack}" v-else>
      <el-input
        :test-name="testName"
        :prefix-icon="iconfont"
        v-bind="$attrs"
...
export default {
  ...
  methods: {
    ...
    focus () {
      this.searchNarrow ? this.$refs.datablauInput.focus() : this.$refs.completeSearchInput.focus()
    },
    handleBlur(event) {
