...
import com.datablau.data.common.api.impl.OperationLogServiceImpl;
import com.datablau.data.common.util.DynamicConfigurations;
import com.datablau.gateway.util.UserFullNameGetterImpl;
...
public class ClientConfiguration {
    ...
    @Bean
    public UserFullNameGetter userFullNameGetter() {
        return new UserFullNameGetterImpl();
    }

    @Bean
    public OperationLogService operationLogService(UserFullNameGetter userFullNameGetter) {
        return new OperationLogServiceImpl(userFullNameGetter);
    }
}
