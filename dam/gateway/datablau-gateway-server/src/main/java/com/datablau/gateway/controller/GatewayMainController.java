    ...
    public RouterFunction<ServerResponse> gatewayMainRoute(){
        ...
        return RouterFunctions.route()
                ...
                .POST("/gateway/main/about", RequestPredicates.accept(MediaType.ALL), request -> {
                    ...
                    about.setTagRcmdEnabled(Boolean.valueOf(dynamicConfig.getPropertyValue("datablau.tag.service.enable", "false")));
                    about.setEsEnabled(Boolean.valueOf(dynamicConfig.getPropertyValue("datablau.ddc.enable", "false")));
                    about.setAuthServerEnabled(Boolean.valueOf(dynamicConfig.getPropertyValue("datablau.auth.server.enable", "false")));
                    about.setKnowledgeGraphEnabled(Boolean.valueOf(dynamicConfig.getPropertyValue("datablau.graph.enable", "false")));
                    about.setStrongPassword(Boolean.valueOf(dynamicConfig.getPropertyValue("configurable.user.force.strong.password", "false")));
