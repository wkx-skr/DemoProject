package com.datablau.reverse.engineering.worker.tidb;
 ...
 * @description: TidbWorker
 * @author: wang tong
 * @create: 2023-08-04 10:03
 **/
public class TidbWorker extends ReverseForwardStrategyJdbc implements JdbcPlugin {

    private static final Logger LOGGER = LoggerFactory.getLogger(TidbWorker.class);
