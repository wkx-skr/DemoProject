package com.datablau.reverse.engineering.worker.etl;
...
import com.datablau.reverse.engineering.dto.EtlJob;
import com.datablau.reverse.engineering.dto.EtlResponse;
import com.datablau.reverse.engineering.dto.MovementPeriodInfo;
 ...
 * @description:
 * @author: wang tong
 * @create: 2025-06-27 11:29
 **/
public class EtlWorker extends ProgressJob implements ReverseForwardStrategy {

    private static final Logger logger = LoggerFactory.getLogger(EtlWorker.class);
    ...
    protected void prepare() throws Exception {
        ...
        this.requestUrl = datasource.getProperties().getParameter("requestUrl");
        this.etlMMSheet1 = datasource.getProperties().getParameter("etlMMSheet1");
        this.etlMMSheet2 = datasource.getProperties().getParameter("etlMMSheet2");
        this.etlMMSheet3 = datasource.getProperties().getParameter("etlMMSheet3");
    ...
    protected void execute() throws Exception {
        ...
        try {
            etlObject(definition, modelId, allJobs);
    ...
    public void etlObject(String definition, Long modelId, List<EtlJob> etlJobs) throws Exception {
