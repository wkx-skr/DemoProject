package com.datablau.datasources.timeseriesview;
...
public class TimeseriesViewSource implements Datasource, ReverseDelegator {
    private static final Logger LOGGER = LoggerFactory.getLogger(TimeseriesViewSource.class);
    ...
    public UUID getUniqueId() {
        return UUID.fromString("E4D58C9C-56CB-4423-8D30-B2013E5F744D");
    }
