package com.datablau.datasources.gis;
...
public class GisDataSource implements Datasource, ReverseDelegator {

    private static final Logger LOGGER = LoggerFactory.getLogger(GisDataSource.class);
    ...
    public UUID getUniqueId() {
        return UUID.fromString("F641A71F-5E75-4A4F-A4EB-949FCF441B0A");
    }
