...
export default {
  ...
  mounted() {
    this.stepsData = [
      {
        label: this.$t('accessStrategy.baseInfo'),
        done: false,
        step: 1,
      },
      {
        label: this.$t('accessStrategy.rowRuleConfig'),
        done: false,
        step: 2,
      },
    ]
  ...
  methods: {
      ...
      switch (name) {
        ...
        case 'save':
          ...
          if (canSkip) {
            ...
            this.$datablauMessage.warning(this.$t('accessStrategy.baseInfoTip'))
            return
          }
          ...
          if (flag) {
            ...
            this.$datablauMessage.warning(
              this.$t('accessStrategy.rowDataTip', {
    ...
    saveStrategy(obj) {
      ...
      HTTP.rowlevelPolicy({
        ...
        .then(res => {
          let text = this.$t('securityModule.newSuccess')
          this.accessControlId && (text = this.$t('securityModule.editSuccess'))
    ...
    async setTip() {
      switch (this.activeStep) {
        case 1:
          ...
          break
        case 2:
          this.$datablauMessage.warning(this.$t('accessStrategy.rowDataTip1'))
          break
        default:
          break
      }
