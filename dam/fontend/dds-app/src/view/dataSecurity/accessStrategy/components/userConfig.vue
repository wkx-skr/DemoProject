<template>
  <div class="userConfig">
    ...
    >
      <el-tab-pane :label="$t('accessStrategy.user')" name="user"></el-tab-pane>
      <el-tab-pane
    ...
    <div class="pane-content">
      <div class="search">
        ...
        <datablau-button
          ...
          @click="addVisitors"
        >
          {{ $t('accessStrategy.add') }}{{ getTypeName(activeName) }}
        </datablau-button>
      </div>
            ...
            <template scope="{row}">
              <template v-if="item.prop === 'action'">
                  ...
                  <el-dropdown-menu slot="dropdown">
                    ...
                    >
                      <el-dropdown-item v-for="k in options" :key="k.value">
                        <el-checkbox :label="k.label" :disabled="k.disabled">
                          {{ k.label }}
                        </el-checkbox>
                      </el-dropdown-item>
                    </datablau-checkbox>
                ...
                <el-tag
                  ...
                  :closable="isEditable && tag !== 'SELECT'"
                ...
                <el-popover
                  ...
                  :title="
                    $t('accessStrategy.executeAction', {
                      num: row.action.length,
                    })
                  "
                  width="380"
                ...
                >
                  ...
                  >
                    {{
                      $t('accessStrategy.moreNum', {
                        num: row.action.length - 3,
                      })
                    }}
                  </span>
                </el-popover>
...
export default {
  ...
  data() {
    return {
      ...
      userColumn: [
        ...
        {
          label: this.$t('accessStrategy.operate'),
          prop: 'operation',
          fixed: 'right',
        },
      ],
  ...
  methods: {
    ...
    deleteSingle(item) {
      this.$DatablauCofirm(
        this.$t('securityModule.sureDelTip', {
          num: this.selectList.length,
        })
      ).then(() => {
        this.deleteVisitor(item)
