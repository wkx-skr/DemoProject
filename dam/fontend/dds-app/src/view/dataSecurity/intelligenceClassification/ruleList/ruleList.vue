  ...
  <div class="rule-list-box">
    ...
    >
      <div class="uploadContent">
        ...
        <datablau-upload
          :action="'/datasecurity/datasecurity/rule/import'"
            ...
            <datablau-list-search style="padding: 10px 20px 0">
              ...
              <template slot="buttons">
                ...
                <el-dropdown
                  ...
                  v-if="
                    $auth.DATA_SECURITY_DISCERN_RULE_UPLOAD ||
                    $auth.DATA_SECURITY_DISCERN_RULE_DOWNLOAD
                  "
                >
                  ...
                  <el-dropdown-menu class="more-drop-box" slot="dropdown">
                    <el-dropdown-item
                      ...
                      command="import"
                      v-if="$auth.DATA_SECURITY_DISCERN_RULE_UPLOAD"
                    >
                    ...
                    <el-dropdown-item
                      ...
                      command="export"
                      v-if="$auth.DATA_SECURITY_DISCERN_RULE_DOWNLOAD"
                    >
            ...
            <div class="table-box">
              <datablau-form-submit>
                <datablau-table
                  ...
                  :data-selectable="
                    $auth.DATA_SECURITY_DISCERN_RULE_MANAGE ||
                    $auth.DATA_SECURITY_DISCERN_RULE_DOWNLOAD
                  "
