<template>
  <div class="machine-page">
    ...
    <div class="head-tip">{{ $t('algorithm.vocabulary') }}</div>
    <div class="head-num">
      <span
    ...
    <div class="head-btn-box">
        ...
        >
          <div class="machine-box">
            <datablau-input
              ...
              :placeholder="$t('algorithm.inputTip')"
              v-model="keyword"
      ...
      >
        ...
        <div class="machine-book">
          ...
          >
            <div class="title">
              {{ $t('securityModule.machineContent') }}
              <div class="book-total">
                {{ $t('securityModule.arctileNum', { num: bookList }) }}
              </div>
            </div>
          </div>
