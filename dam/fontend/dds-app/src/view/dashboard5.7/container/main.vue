    ...
    <div class="forPdf">
      ...
      >
        <datablau-transfer
          ...
          :titles="[$t('assetCount.canSelect'), $t('assetCount.hasAdd')]"
          :button-texts="[$t('assetCount.remove'), $t('assetCount.add')]"
          :filter-placeholder="$t('assetCount.inputComName')"
      ...
      >
        ...
        <datablau-button
          ...
          :tooltipContent="$t('assetCount.fullscreen')"
        ></datablau-button>
        <datablau-button
          v-else
        ...
        >
          <datablau-button
            ...
            :tooltipContent="$t('assetCount.configure')"
          ></datablau-button>
          <!--<el-button
          v-if="$isAdmin && editMode"
          size="mini"
        ...
        >退出编辑模式</el-button>-->
          ...
          >
            {{
              proMode
                ? $t('assetCount.collapseAdvanced')
                : $t('assetCount.advancedAttr')
            }}
          </datablau-button>
          <template v-if="editMode && proMode">
            {{ $t('assetCount.columnGrids') }}
            <el-input-number
              size="mini"
              :min="3"
              :max="gridsNum"
