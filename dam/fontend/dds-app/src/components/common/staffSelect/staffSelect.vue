<template>
  <div>
    <datablau-dialog
      custom-class="staff-select-dialog"
      ...
      @close="closeDialog"
    >
      <div class="body left" :class="{ 'hide-org': !$damEnabled }">
        <datablau-input
          clearable
      ...
      <div class="staff-select-header" :class="{ 'hide-org': !$damEnabled }">
        <datablau-input
          class="width query1"
      ...
      <div class="tableStaff" :class="{ 'hide-org': !$damEnabled }">
