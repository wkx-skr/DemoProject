    ...
    return {
      applyTypesMap: {
        ...
        发布目录申请: {
          ...
          value: this.$t('userPane.userPane.发布目录申请'),
          businessType: 'zichanmulu',
        },
        下线目录申请: {
          label: this.$t('userPane.userPane.label_下线目录申请'),
          value: this.$t('userPane.userPane.下线目录申请'),
          businessType: 'xiaxianmulu',
        },
        变更目录申请: {
          label: this.$t('userPane.userPane.label_变更目录申请'),
          value: this.$t('userPane.userPane.变更目录申请'),
          businessType: 'biangengmulu',
        },
        资产发布申请: {
          label: this.$t('userPane.userPane.label_资产发布申请'),
          value: this.$t('userPane.userPane.资产发布申请'),
          businessType: 'shujuzichan',
        },
        资产下线申请: {
          label: this.$t('userPane.userPane.label_资产下线申请'),
          value: this.$t('userPane.userPane.资产下线申请'),
          businessType: 'zichanxiaxian',
        },
        资产目录权限申请: {
        ...
        业务规则: {
          label: this.$t('userPane.userPane.label_业务规则'),
          value: this.$t('userPane.userPane.业务规则'),
          businessType: 'yewuguize',
        },
        数据建模: {
          label: this.$t('userPane.userPane.label_数据建模'),
          value: this.$t('userPane.userPane.数据建模'),
          businessType: 'shujujianmo',
        },
      },
      resultMap: {
        审核通过: {
