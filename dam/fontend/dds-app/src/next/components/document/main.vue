<template>
  <div class="container">
    <div class="left-part">
      ...
      >
        ...
        <el-submenu index="service">
          ...
          <el-menu-item index="service-lable">标签选择</el-menu-item>
        </el-submenu>
      </el-menu>
    </div>
    <div class="right-part">
      ...
      <service-lable v-if="currentIndex === 'service-lable'"></service-lable>
...
import ServiceLable from './service/lable.vue'
