<template>
  <div class="container" :style="{ backgroundColor: BACKGROUND_COLOR }">
    <div class="forPdf">
      ...
      <datablau-dialog
        :title="$t('common.dashboard.componentSelector')"
        width="940px"
      ...
      >
        <datablau-transfer
          ...
          :titles="[
            $t('common.dashboard.optional'),
            $t('common.dashboard.added'),
          ]"
          :button-texts="[
            $t('common.dashboard.remove'),
            $t('common.dashboard.add'),
          ]"
          :filter-placeholder="$t('common.dashboard.fillComponentName')"
