        ...
        if (query[0].query.length > 1) {
          ...
          for (let i = 0; i < query2.length; i++) {
            if (!query2[i].metricMappingId) {
              ...
              !query2[i].value ||
              query2[i].comparisonOperator == 'NOT_NULL' ||
              query2[i].comparisonOperator == 'IS_NULL'
            ) {
              this.$message.error(
                this.$t('indicator.apply.errorMessage.noValues')
              )
          ...
          if (!query[0].query[0].metricMappingId) {
            ...
            query[0].query[0].comparisonOperator == 'NOT_NULL' ||
            query[0].query[0].comparisonOperator == 'IS_NULL'
          ) {
