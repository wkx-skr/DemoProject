    ...
    >
      <div style="padding: 10px 20px">
        <el-form
          ...
          inline
          label-position="right"
          :label-width="$i18n.locale === 'en' ? '14em' : '8em'"
          :rules="formRules"
          ref="form"
          :model="formData"
        >
          ...
          <div>
            ...
            <el-form-item :label="$t('meta.DS.tableDetail.knowledgeGraph.edges.techLeader')" prop="technicalLeader">
              <datablau-input
            ...
            <el-form-item :label="$t('meta.DS.tableDetail.knowledgeGraph.edges.busiLeader')" prop="businessLeader">
              <datablau-input
            ...
            <el-form-item :label="$t('indicator.demand.taskProps.managementLeader')" prop="managementLeader">
              <datablau-input
            ...
            <el-form-item :label="$t('indicator.dimension.state')" prop="stauts">
            ...
            <el-form-item :label="$t('meta.lineageManage.desc')" prop="description">
              <datablau-input
