...
export default {
  ...
  methods: {
    ...
    getAlert (row) {
      // this.$http
      //   .post(
      //     `${this.$metric_url}metricManagement/metricWarning/get?metricWarningId=${row.id}`
      //   )
      //   .then(res => {
    ...
    save () {
      let url
      if (this.editMode) {
        url = `${this.$metric_url}metricManagement/metricWarning/update?metricWarning=${this.formData.id}`
      } else {
        url = `${this.$metric_url}metricManagement/metricWarning/add`
      }
      this.$http
        .post(url, {
          id: this.formData.id,
