...
<script>
import ViewDetail from '@/view/dataIndexNew/indexManagement/indexDefinition/viewDetail.vue'
import _ from 'lodash'
import { IndexType } from '@/view/dataIndexNew/indexManagement/indexDefinition/class/Enum'
import HTTP from '@/http/main.js'
import { CategoryId } from '@/view/dataIndexNew/indexManagement/indexDefinition/entrance/Constant'
...
export default {
  ...
  methods: {
    ...
    getUdps() {
      HTTP.getUpdsMetric({ categoryId: CategoryId[this.indexPage] })
        .then(res => {
          let data = res.data
    ...
    getDomain(callback) {
      this.$http
        .post(`${this.$metric_url}domains/domain/getDomainById`, {
