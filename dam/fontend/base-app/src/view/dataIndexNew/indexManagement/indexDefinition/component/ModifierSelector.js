import {
  Label,
  ModifierCategory,
} from '@/view/dataIndexNew/modifier/entrance/Constant'
import ModifierValueSelector from '@/view/dataIndexNew/indexManagement/indexDefinition/component/ModifierValueSelector'
...
export default {
  ...
  methods: {
    ...
    getTreeData() {
      let url = `${
        this.$metric_url
      }categories/tree?type=${this.getTreeLDMType()}`
