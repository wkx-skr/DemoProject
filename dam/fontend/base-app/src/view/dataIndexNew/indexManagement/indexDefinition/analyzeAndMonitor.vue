...
export default {
  ...
  methods: {
    ...
    getData() {
      this.$http
        .post(
          `${this.$metric_url}metricManagement/metricWarning/result?metricId=${this.metricId}`
        )
        .then(res => {
    ...
    getData2(timestamp) {
      this.$http
        .post(
          `${this.$metric_url}metricManagement/metricWarning/result/details?metricId=${this.metricId}&time=${timestamp}`
        )
        .then(res => {
