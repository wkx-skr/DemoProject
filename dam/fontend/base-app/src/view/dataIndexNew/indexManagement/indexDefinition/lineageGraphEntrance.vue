<template>
  ...
  >
    ...
    >
      ...
      <!-- <span
        v-if="!isReport && $featureMap.FE_QUALITY"
        class="show-label"
        style="margin-left: 20px"
      >
...
<script>
import focusSwitchButton from '../indexDefinition/lineage/focusSwitchButton'
import LineageGraph from '../indexDefinition/lineageComponents/main/lineageGraph.vue'
...
import detailTabs from '../indexDefinition/lineage/detailTabs.vue'
export default {
  components: {
    LineageGraph,
    focusSwitchButton,
  ...
  methods: {
    ...
    getRawData() {
      ...
      if (this.isReport) {
        ...
        const url = `/metric/metricManagement/lineage?metricId=${this.objectId}&type=${type}`
    ...
    exportExcel() {
      ...
      const url = `/metric/metricManagement/metric/excel?metricId=${this.objectId}&type=${type}`
