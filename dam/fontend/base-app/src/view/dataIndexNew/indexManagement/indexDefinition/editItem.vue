<template>
  <div style="padding: 0 20px">
    ...
    >
      ...
      ></el-tab-pane>
      <el-tab-pane
        v-if="viewMode && permission && permission.includes('指标预警') && !isAssets"
      ...
      <div style="padding: 10px 20px">
        ...
        >
          <datablau-detail-subtitle
            :title="$t('domain.domain.baseInfo')"
            mt="20px"
          ></datablau-detail-subtitle>
          <div>
            <el-form-item
          ...
          <datablau-detail-subtitle
            :title="$t('domain.domain.businessInfo')"
            mt="20px"
          ></datablau-detail-subtitle>
          <div>
            <el-form-item
          ...
          <datablau-detail-subtitle
            :title="$t('domain.domain.techInfo')"
            mt="20px"
          ></datablau-detail-subtitle>
          <div>
            <el-form-item label="信息类型" prop="rangeType">
              <datablau-select
                size="mini"
                clearable
                class="inline-input"
          ...
          >
            <datablau-detail-subtitle
              :title="$t('domain.domain.manageInfo')"
              mt="20px"
            ></datablau-detail-subtitle>
