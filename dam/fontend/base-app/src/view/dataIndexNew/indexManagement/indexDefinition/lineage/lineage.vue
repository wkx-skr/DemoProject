...
export default {
  ...
  methods: {
    ...
    bindLineage() {
      this.$http
        .post(
          this.$meta_url + `/service/entities/view/${this.objectId}/tables/bind`
        )
        .then(res => {
    ...
    unbindSp() {
      this.$http
        .post(this.$meta_url + '/service/lineage/unbind/sp', this.lineageData)
        .then(res => {
    ...
    checkIfBound() {
      this.$http
        .get(
          this.$meta_url +
            `/service/entities/view/${this.objectId}/tables/bound`
        )
        .then(res => {
          this.bound = res.data
        })
    ...
    analysize() {
      this.$http
        .post(
          this.$meta_url +
            `/service/entities/view/${this.objectId}/tables/analysis`
        )
        .then(res => {
    ...
    exportExcel() {
      ...
      // this.$downloadFile(this.$meta_url+ '/service/lineage/excel?objectId=' + this.data.objectId)
    },
