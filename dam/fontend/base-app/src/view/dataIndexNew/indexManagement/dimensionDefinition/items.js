...
export default {
  ...
  methods: {
    ...
    getData(data) {
      ...
      let url = `${this.$metric_url}dimension/page`
    ...
    DeleteClick(row) {
      this.$DatablauCofirm(
        ...
        .then(() => {
          ...
          let url = `${this.$metric_url}dimension/delete`
          this.$http
            .post(url, ids)
            .then(res => {
    ...
    exportIndex() {
      const url = `${this.$metric_url}dimension/export`
      this.$downloadFilePost(url, this.prepareSearchCondition())
    },
    downloadTemplate() {
      const url = `${this.$metric_url}dimension/downloadTemplate`
