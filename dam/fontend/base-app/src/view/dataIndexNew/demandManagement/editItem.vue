    ...
    onSubmit () {
      this.$refs.form.validate(valid => {
        if (!valid) {
          ...
          let url = `${this.$metric_url}requirementmanagement/update`
          let body = this.formData
          if (this.iscreate) {
            // 新建需求
            url = `${this.$metric_url}requirementmanagement/create`
          ...
          this.$http
            ...
            .then(res => {
              ...
              let url = `${this.$metric_url}requirementmanagement/requirementdataobject/maintain?requirementId=${requirementId}`
              let body = []
