...
export default {
  ...
  methods: {
    getSetting () {
      let url = `${this.$metric_url}metricManagement/metricWarning/setting`
      this.$http
        .get(url)
        .then(res => {
          console.log(res, 'res')
    ...
    getTasksList () {
      let url = `${this.$metric_url}metricManagement/metricWarning/tasks`
      this.$http
        .get(url)
        .then(res => {
    ...
    runJob () {
      let url = `${this.$metric_url}metricManagement/metricWarning/execute`
      this.$http
        .get(url)
        .then(res => {
