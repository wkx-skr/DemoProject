<template>
  ...
  >
    <div style="" v-if="pageFrom !== 'history'">
    ...
    <datablau-form-submit
      :style="{ 'margin-top': pageFrom === 'history' ? '0px' : '84px' }"
...
export default {
  ...
  data() {
    return {
      ...
      poperationOption: [
        ...
        {
          label: this.$t('assets.logs.operationOption.label_login'),
          value: 'BASIC_ADD',
        },
        {
          label: this.$t('assets.logs.operationOption.label_query'),
          value: 'BASIC_DELETE',
        },
        {
          label: this.$t('assets.logs.operationOption.label_add'),
          value: 'BASIC_SEARCH',
        },
        {
        ...
        // {
        //   label: this.$t('assets.logs.operationOption.release'),
        //   value: 'BASIC_RELEASE',
        // },
        // {
        //   label: this.$t('assets.logs.operationOption.offline'),
        //   value: 'BASIC_OFFLINE',
        // },
        {
        ...
        {
          label: this.$t('assets.logs.operationOption.attribute'),
          value: 'ADD_EXTENDED_ATTRIBUTE',
        },
        {
          label: this.$t('assets.logs.operationOption.modifyAttribute'),
          value: 'MODIFY_EXTENDED_ATTRIBUTE',
        },
        // {
        //   label: this.$t('assets.logs.operationOption.examineOffline'),
        //   value: 'EXAMINE_OFFLINE',
        // },
        // {
        //   label: this.$t('assets.logs.operationOption.examineRelease'),
        //   value: 'EXAMINE_RELEASE',
        // },
      ],
      column: [
        {
  ...
  methods: {
    ...
    initData() {
      ...
      this.$http
        .post(`${this.$url}/service/oplog/record`, obj)
        .then(res => {
          this.loading = false
