<template>
  <div style="background: #fff" class="picBox" v-loading="loading">
    ...
    <template v-if="datas">
      ...
      <div class="echart-container" v-if="datas.length !== 0">
              ...
              normal: {
                ...
                formatter: function (params) {
                  ...
                  params.name.length >= 8
                    ? (names = params.name.substr(0, num) + '…')
                    : (names = params.name)
                  if (params.dataIndex === 0) {
                    return `{a|${params.dataIndex + 1}}  {e|${names}}`
                  } else if (params.dataIndex === 1) {
                    return `{b|${params.dataIndex + 1}}  {e|${names}}`
                  } else if (params.dataIndex === 2) {
                    return `{c|${params.dataIndex + 1}}  {e|${names}}`
                  } else {
                    return `{d|${params.dataIndex + 1}}  {e|${names}}`
                  }
                },
                rich: {
                  a: {
