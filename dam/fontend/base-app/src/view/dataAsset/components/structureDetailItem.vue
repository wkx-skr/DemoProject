    ...
    <datablau-form-submit class="table-row" ref="tableOuter">
      <div class="boxNameTop detailBox">
        ...
        >
          ...
          >
            ...
            <span v-if="mes" class="repeatNameTypeText">
              {{ $t('assets.generalSettings.directoryStructure') }}
            </span>
          </el-form-item>
          <el-form-item
        ...
        <datablau-radio
          ...
          v-model="level"
          @change="radioChang"
          :disabled="structure.openStatus && structure.id"
        >
          <el-radio
            :label="item.value"
                  ...
                  :class="[
                    'selectBox',
                    {
                      detailDtosBorderRead:
                        detailDtosBorderRead && !items.catalogTypeId,
                    },
                  ]"
                  style="width: 280px"
                >
                ...
                >
                  <div slot="content">
                    ...
                    <datablau-detail-subtitle
                      ...
                      mb="5px"
                    ></datablau-detail-subtitle>
                    <div>完成度的计算公式：{{ items.textMula }}</div>
                  </div>
        ...
        <div class="approverBox">
          <div class="flexDisplay alignItems approverDiv">
            ...
            <span class="borderReadText" v-if="borderRead">
              {{ $t('assets.directoryStructure.approverRequired') }}
            </span>
          </div>
          <div class="flexDisplay alignItems administrator">
            ...
            <span class="borderReadText" v-if="manager">
              {{ $t('assets.directoryStructure.administratorRequired') }}
            </span>
          </div>
          <div class="flexDisplay alignItems radioBox">
            ...
            <span v-if="publicBorderRed">
              {{ $t('assets.directoryStructure.publicText') }}
            </span>
          </div>
        </div>
      </div>
...
export default {
  ...
  data() {
    return {
      rules: {
        name: [
          {
            message: this.$t('assets.directoryStructure.nameRequired'),
            trigger: 'blur',
            required: true,
          },
        ],
  ...
  methods: {
    ...
    publicChange(val) {
      val && (this.publicBorderRed = false)
    },
    lazyloading() {
      this.page++
    ...
    changeValue(item, val) {
      ...
      if (item.id) {
        ...
        //       )
        //     }
        //     this.$emit('setOld', { key: val, val: item[val] })
        //   })
        //   .catch(e => {
        //     this.$showFailure(e)
        //   })
    ...
    saveItem(item, openStatus) {
      ...
      !flag && (this.detailDtosBorderRead = true)
...
/deep/ .borderRead .el-input__inner,
/deep/ .detailDtosBorderRead .el-input__inner {
  border-color: #ff4b53;
  &:hover {
    border-color: #ff4b53;
  }
