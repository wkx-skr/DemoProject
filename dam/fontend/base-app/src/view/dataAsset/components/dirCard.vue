  ...
  >
    <template v-if="isAdd">
      <div @click="handleCardClick" style="padding-top: 20px; height: 100%">
        <img
          src="/static/images/dataAssets/plus.svg"
          alt=""
    ...
    <div v-else :class="dirData.type" @click="handleCardClick">
        ...
        >
          ...
          >
            <img
              ...
              style="height: 14px"
            />
            <span>{{ $t('assets.common.publishedText') }}</span>
          </div>
          <div
          ...
          >
            <img
              ...
              style="height: 14px"
            />
            <span>{{ $t('assets.common.reviewText') }}</span>
          </div>
          <div
          ...
          >
            <img
              ...
              style="height: 14px"
            />
            <span>{{ $t('assets.common.unpublishText') }}</span>
          </div>
          <div v-if="dirData.status === 'OFFLINE'" class="child-status offline">
            <img
              ...
              style="height: 14px"
            />
            <span>{{ $t('assets.common.offlineText') }}</span>
          </div>
          <el-rate
            class="dir-star"
        ...
        if (this.authFunction && !this.authFunction(this.dirData)) {
          ...
          let errorMsg = this.authTooltip
            ...
            : this.$t('assets.catalogue.noPermission', {
                ...
                type: this.$t('assets.catalogue.access'),
              })
