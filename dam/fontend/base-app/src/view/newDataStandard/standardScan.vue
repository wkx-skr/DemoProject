      ...
      >
        <el-tab-pane :label="$t('domain.domain.infoShow')" name="first">
          ...
          <div class="prop-line alg-line">
            ...
            <div class="details-box">
              <div class="detail" v-if="categoryTypeId === 1">
                <span class="label">
                  {{ $t('domain.domain.weatherDomainStandard') }}
                </span>
                <span class="value">
                  {{
                    details.refDomainId
              ...
              <div class="detail" v-if="details.refDomainId">
                <span class="label">
                  {{ $t('domain.domain.domainStandardType') }}
                </span>
                <span class="value">
                  <datablau-button type="text" @click="goParentDomain">
                    {{ details.parentDomainName }}
                  </datablau-button>
                </span>
              </div>
              <div class="detail">
