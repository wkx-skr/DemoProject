      ...
      >
        <el-form-item prop="domainName" style="width: 200px">
          <datablau-input
            ...
            :placeholder="
              $t('domain.domain.domainTypeName', { type: labelText.name })
            "
          ></datablau-input>
        </el-form-item>
        <el-form-item prop="domainCode" style="width: 200px">
          <datablau-input
            ...
            :placeholder="
              $t('domain.domain.domainTypeCode', { type: labelText.name })
            "
          ></datablau-input>
        </el-form-item>
        ...
        <el-form-item
          v-if="$esEnabled && (typeIds === 1 || typeIds > 4)"
          label="扩展属性查询"
        >
          <datablau-select
      ...
      <template slot="buttons">
        <div style="margin-right: 20px">
          ...
          >
            ...
            ></i>
            <i v-show="showSelect" class="el-icon-arrow-up el-icon--right"></i>
          </datablau-button>
        </div>
    ...
    >
      ...
      >
        ...
        <el-table-column
          min-width="120px"
          :label="
            labelText.name === $t('domain.common.dataStandard')
              ? $t('domain.common.domainName')
              : labelText.name
          "
          prop="chineseName"
