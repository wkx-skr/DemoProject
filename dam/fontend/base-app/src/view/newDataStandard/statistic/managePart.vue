  ...
  <div class="manage-container" style="min-width: 800px">
    <div class="form-part">
      <el-form :inline="true">
        ...
        <el-form-item>
          <datablau-button type="normal" size="mini" @click="search()" :disabled="tableLoading||updateRefresh">
...
export default {
  ...
  methods: {
    ...
    init() {
      ...
      this.$http
        .post(
          this.$url + '/service/dashboard/domain/count/department',
          requestBody
        )
        .then(res => {
    ...
    initDrop() {
      this.$http
        .get(this.$url + '/service/dashboard/domain/count/department/drop')
        .then(res => {
    ...
    exportFileSearch() {
      ...
      this.$downloadFilePost(
        this.$url + '/service/dashboard/domain/count/department/export',
        requestBody,
