    ...
    <div class="theme-detail">
      <datablau-form-submit>
        <div>
          <div class="form-part">
            <el-form :inline="true">
              <el-form-item :label="`${$t('domain.common.theme')}:`" class="theme-filter-input">
              ...
              <el-form-item :label="`${$t('domain.common.domainName')}:`" class="theme-filter-input">
                <datablau-input
                  maxlength="100"
                  type="text"
                  size="mini"
              ...
              <el-form-item :label="`${$t('domain.common.system')}:`" class="theme-filter-input">
              ...
              <el-form-item :label="`${$t('domain.common.domainPropCode')}:`" class="theme-filter-input">
                <datablau-input
                  maxlength="100"
                  type="text"
                  size="mini"
          ...
          <div class="table-part" :style="{ top: topNum + 'px' }">
            ...
            >
              <el-table-column type="index" width="50" :label="$t('domain.common.orderIndex')"></el-table-column>
              <el-table-column prop="theme" :label="$t('domain.common.themeName')" min-width="50"></el-table-column>
              <el-table-column prop="categoryName" :label="$t('domain.common.systemName')"
                               min-width="50"></el-table-column>
              <el-table-column prop="domainName" :label="$t('domain.common.domainName')"
                               min-width="50"></el-table-column>
              <el-table-column prop="domainCode" :label="$t('domain.common.domainPropCode')"
                               min-width="50"></el-table-column>
              <el-table-column
                prop="refCount"
        ...
        <template slot="buttons">
          <div class="bottom-line">
            <div class="left-btn">
              <span class="footer-row-info" v-show="idArr.length && idArr.length > 0">
                {{
              ...
              <div class="bottom-btns-container" v-show="idArr.length && idArr.length">
                <datablau-button
                  size="mini"
                  class="iconfont icon-export"
                  type="important"
...
export default {
  ...
  methods: {
    ...
    getDropList() {
      this.$http
        .get(this.$url + '/service/dashboard/domain/count/theme/detail/drop')
        .then(res => {
    ...
    init() {
      return new Promise(resolve => {
        ...
        this.$http
          .post(this.$url + '/service/dashboard/domain/count/theme/detail', obj)
          .then(res => {
    ...
    handleExport(index) {
      if (index === 1) {
        const url = `${this.$url}/service/dashboard/domain/count/theme/detail/export`
        const obj = {
          theme: this.themeValue,
          categoryName: this.systemValue,
          domainName: this.standardValue,
        ...
        this.$downloadFilePost(url, obj, this.$t('domain.queryStandard.domainQuoteCount'))
      } else if (index === 2) {
        ...
        this.$downloadFilePost(url, {countIds: ids}, this.$t('domain.queryStandard.domainQuoteCount'))
      }
    },
  },
}
