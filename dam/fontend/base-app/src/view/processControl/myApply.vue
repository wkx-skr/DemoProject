  ...
  methods: {
          ...
          .then(res => {
            ...
            res.data.value.forEach(item => {
              ...
              for (let key in this.resultMap) {
                if (item.result && item.result === key) {
            ...
            if (res.data.properties && res.data.properties.processType) {
              ...
              this.resultOption = [{ label: '全部', value: '' }].concat(
                Object.values(this.resultMap)
              )
            }
            this.tableData = data
    ...
    setGetAllData(para) {
      this.getAllData = HTTP.getMyApply({
        ...
        processType: this.processTypeValue ? this.processTypeValue : null,
