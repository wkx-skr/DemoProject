<template>
  <div>
    <datablau-form
      :model="editBody"
      :label-width="$i18n.locale === 'zh' ? '8em' : '120px'"
      :rules="editRules"
      ref="form"
      size="m"
    >
      <el-form-item
        :label="$t('meta.process.editFormItem.code')"
        :rules="{
          required: true,
          message: $t('meta.process.editFormItem.codeMessage'),
        }"
        prop="code"
      >
        <datablau-input
      ...
      <el-form-item
        :label="$t('meta.process.editFormItem.name')"
        :rules="{
          required: true,
          message: $t('meta.process.editFormItem.nameMessage'),
        }"
        prop="name"
      >
        <datablau-input
      ...
      <el-form-item :label="$t('meta.process.editFormItem.valueDomainType')">
        <datablau-select
        ...
        >
          <el-option
            v-for="(o, i) in RangeTypeOptionLabel"
            :key="i"
            :value="RangeTypeOption[i]"
            :label="o"
          ></el-option>
        </datablau-select>
      </el-form-item>
      <el-form-item
        :label="$t('meta.process.editFormItem.defaultValue')"
        prop="value"
        ref="value"
      ...
      >
        ...
        <datablau-datePicker
          ...
          :placeholder="$t('meta.process.editFormItem.selectDate')"
          style="width: 100%"
        ...
        <datablau-input
          ...
          :placeholder="$t('meta.process.editFormItem.approverPlaceholder')"
          style="width: 100%"
          @focus="selectUser"
        ...
        <datablau-select
          ...
          v-model="editBody.value"
          clearable
          :placeholder="$t('meta.process.editFormItem.namePlaceholder')"
        >
          <el-option
        ...
        <datablau-input
          ...
          clearable
          :placeholder="$t('meta.process.editFormItem.departmentPlaceholder')"
          style="width: 100%"
          @focus="selectBranch"
        ...
        <datablau-input
          ...
          v-else
          v-model="editBody.value"
          :placeholder="$t('meta.process.editFormItem.defaultValuePlaceholder')"
      ...
      <el-form-item
        :label="$t('meta.process.editFormItem.enumerateItems')"
        v-show="editBody.type === 'ENUM'"
      >
        <datablau-input
          show-word-limit
          ...
          :placeholder="$t('meta.process.editFormItem.alternativePlaceholder')"
          style="width: 100%"
        ></datablau-input>
      </el-form-item>
      <el-form-item
        :label="$t('meta.process.editFormItem.other')"
        prop="readable"
        v-if="!isExpress"
      ...
      >
        <el-checkbox
          ...
          :label="$t('meta.process.editFormItem.thusClearThat')"
        ></el-checkbox>
        <el-checkbox
          name="writable"
          v-model="editBody.writable"
          :label="$t('meta.process.editFormItem.editable')"
        ></el-checkbox>
        <el-checkbox
          name="required"
          v-model="editBody.required"
          :label="$t('meta.process.editFormItem.must')"
        ></el-checkbox>
      </el-form-item>
      ...
      <!-- v-if="isExpress" -->
      <el-form-item
        :label="$t('meta.process.editFormItem.approverExpression')"
        prop="express"
        v-if="isExpress"
      >
        <datablau-select
          ...
          :placeholder="$t('meta.process.editFormItem.pleaseSelect')"
        ...
        <datablau-input
          ...
          type="textarea"
          :autosize="{ minRows: 3, maxRows: 6 }"
          :placeholder="$t('meta.process.editFormItem.expressionPlaceholder')"
        ...
        >
          <a
            ...
            style="color: #409eff"
          >
            {{ $t('meta.process.editFormItem.viewInput') }}
          </a>
        </datablau-button>
      </el-form-item>
    </datablau-form>
...
import { RangeTypeOption, RangeTypeOptionLabel } from './RangeTypeOption'
export default {
  ...
  mounted() {
    if (this.currentRow) {
      ...
      if (this.currentRow.type === 'ROLE') {
        this.currentRow.value = Number.parseInt(this.currentRow.value)
      }
  ...
  computed: {
    ...
    RangeTypeOption() {
      return RangeTypeOption
    },
    RangeTypeOptionLabel() {
      return RangeTypeOptionLabel
    },
  },
  methods: {
    beforeSave() {
