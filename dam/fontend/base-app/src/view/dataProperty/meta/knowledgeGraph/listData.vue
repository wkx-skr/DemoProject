    ...
    <datablau-table :data="listData" height="100%">
      <el-table-column :width="40" align="right">
        <template slot-scope="scope">
          <img
            :src="'static/kgimg/' + scope.row.startNode.typeId + '.svg'"
            style="width: 24px"
            alt=""
      ...
      <el-table-column
        :label="$t('meta.DS.tableDetail.knowledgeGraph.source')"
        show-overflow-tooltip
      >
        <template slot-scope="scope">
          {{
      ...
      <el-table-column
        :label="$t('meta.DS.tableDetail.knowledgeGraph.relType')"
        show-overflow-tooltip
      >
        <template slot-scope="scope">
      ...
      <el-table-column
        :label="$t('meta.DS.tableDetail.knowledgeGraph.intro')"
        show-overflow-tooltip
      >
        <template slot-scope="scope">
      ...
      <el-table-column :width="40" align="right">
        <template slot-scope="scope">
          <img
            :src="'static/kgimg/' + scope.row.endNode.typeId + '.svg'"
            style="width: 24px"
            alt=""
