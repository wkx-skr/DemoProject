<template>
  <datablau-dialog
    ...
    size="l"
    :title="$t('meta.DS.tableDetail.knowledgeGraph.sourceSel')"
    :key="comKey"
  >
    <div>
      <datablau-input
      ...
      >
        ...
        <el-table-column
          prop="alias"
          :label="$t('meta.DS.tableDetail.knowledgeGraph.enName')"
          show-overflow-tooltip
        ></el-table-column>
        <el-table-column
          prop="Name"
          :label="$t('meta.DS.tableDetail.knowledgeGraph.zhName')"
          show-overflow-tooltip
        ></el-table-column>
        <el-table-column
          prop="description"
          :label="$t('meta.DS.tableDetail.knowledgeGraph.desc')"
          show-overflow-tooltip
        ></el-table-column>
        <el-table-column
          prop="path"
          :label="$t('meta.DS.tableDetail.knowledgeGraph.path')"
          show-overflow-tooltip
        >
          <template slot-scope="scope">
