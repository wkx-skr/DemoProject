<template>
  <div>
    <datablau-button @click="newRelation(null)">
      {{ $t('meta.DS.tableDetail.knowledgeGraph.createRel') }}
    </datablau-button>
    <common-selector
      ref="assetSelector"
    ...
    ></common-selector>
    <datablau-dialog
      :title="$t('meta.DS.tableDetail.knowledgeGraph.createRel')"
      size="l"
      :height="500"
      :visible.sync="visible"
    >
      <datablau-form label-width="6em" :model="json" ref="form" :rules="rules">
        <el-form-item :label="$t('meta.DS.tableDetail.knowledgeGraph.relType')">
          <datablau-select v-model="json.relationshipType">
            <el-option
              :label="$t('meta.DS.tableDetail.knowledgeGraph.customType')"
              :value="$t('meta.DS.tableDetail.knowledgeGraph.customType')"
            ></el-option>
          </datablau-select>
        </el-form-item>
        <el-form-item
          :label="$t('meta.DS.tableDetail.knowledgeGraph.sourceType')"
        >
        ...
        <el-form-item
          :label="$t('meta.DS.tableDetail.knowledgeGraph.sourceObj')"
          prop="sourceId"
        >
          <datablau-input
            :value="sourceObject"
        ...
        <el-form-item
          :label="$t('meta.DS.tableDetail.knowledgeGraph.targetType')"
        >
          <datablau-select
        ...
        <el-form-item
          :label="$t('meta.DS.tableDetail.knowledgeGraph.targetObj')"
          prop="targetId"
        >
          <datablau-input
            :value="targetObject"
        ...
        <el-form-item
          :label="$t('meta.DS.tableDetail.knowledgeGraph.relIntro')"
        >
          <datablau-input
...
<script>
import CommonSelector from '@/view/dataProperty/meta/knowledgeGraph/CommonSelector.vue'
  ...
  data() {
    return {
      ...
      json: {
        ...
        relationshipType: this.$t(
          'meta.DS.tableDetail.knowledgeGraph.customType'
        ),
      },
      rules: {
        sourceId: {
          required: true,
          message: this.$t('meta.DS.tableDetail.knowledgeGraph.sourceRequired'),
        },
        targetId: {
          required: true,
          message: this.$t('meta.DS.tableDetail.knowledgeGraph.targetRequired'),
        },
      },
