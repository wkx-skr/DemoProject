<template>
  <div class="tag-rule">
    ...
    >
      <div class="rule-form" v-show="showRuleForm && ruleType === 'meta'">
        <el-form size="small" label-width="8em">
          <el-form-item
            style="visibility: hidden; height: 11px"
            label="数据类型"
          >
    ...
    <el-form size="small" label-position="right" label-width="6em">
      ...
      <el-form-item v-show="isMeta" label="匹配阈值">
        <el-input-number
          size="mini"
          v-model="threshold"
          :min="1"
      ...
      <!-- <div>
        匹配阈值
        <el-input-number size="mini" v-model="threshold" :min="1" :max="100"></el-input-number>
        <br><br>
      </div> -->
      <el-form-item>
        <div
          v-show="ruleType"
          style="height: 50px; padding-left: 0px; padding-top: 2em"
        >
          <datablau-button
