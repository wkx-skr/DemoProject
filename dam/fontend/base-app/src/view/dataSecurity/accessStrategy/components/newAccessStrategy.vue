  ...
  methods: {
    ...
    getFirstData() {
      ...
      HTTP.getstrategyDetail(this.accessControlId)
        .then(res => {
          this.strategyData.second = res.data.data
          this.rangeMap = {
            oriSchemaRange: res.data.data.schemaRange,
            oriTableRange: res.data.data.tableRange,
            oriColumnRange: res.data.data.columnRange,
            oriSchemaInfo: res.data.data.schemaNameList,
            oriModelId: res.data.data.modelId,
          }
