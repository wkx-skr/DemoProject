  ...
  <div class="tag-rule">
    ...
    <!-- <div class="title">
      <span style="font-size:12px;margin-left:1em;" v-if="ruleType">
        ...
        <el-button @click="handleChangeType" type="text" size="mini">切换规则类型</el-button>
      </span>
    </div> -->
    <!-- <div v-if="!rules && ruleType !=='regex'" style="text-align:left;height:3em;line-height:3em;">
      暂无标签识别规则
      <el-button
        @click="addRootShape"
      ...
      <el-button
        ...
        size="small"
        type="text"
      >添加基于数据的正则表达式规则</el-button>
      <el-button
        @click="addRootShapeForMeta"
        size="small"
        type="text"
      >添加基于元数据的规则</el-button>
    </div> -->
    <el-input
      v-if="ruleType === 'regex'"
      type="textarea"
