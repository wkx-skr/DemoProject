<template>
  <div>
    <el-form
      ...
      :label-width="$i18n.locale === 'zh' ? '110px' : '130px'"
      style="padding-top: 18px"
    >
      <el-form-item :label="$t('userPane.myTodo.applyReason') +':' ">
        <div>{{ techRule.applyReason }}</div>
      </el-form-item>
      <el-form-item :label="$t('userPane.myTodo.attachments') +':' ">
        <div class="doc">
          ...
          >
            ...
            {{ $t('userPane.myTodo.downloadAttachments') }}
          </datablau-button>
        </div>
      </el-form-item>
    </el-form>
              ...
              .then(res => {
                this.$nextTick(() => {
                  this.techRule.applyFileName =
                    res.data[0]?.fileName || this.$t('userPane.myTodo.noAttachment')
                })
              })
          }
        }
