  ...
  <div class="edit-vertify-container">
    <datablau-form-submit>
      <div class="edit-domain-vertify">
        <h3 class="edit-page-title">{{ $t('domain.verification.uncheckedIssueTracking') }}</h3>
        <div class="col-prop">
        ...
        <div class="domain-prop">
          <p class="part-title">{{ $t('domain.verification.mappedDataStandards') }}</p>
          <datablau-form
            :model="colData"
            ref="form"
          >
            <el-form-item :label="$t('domain.common.dataStandard')">
              <span class="item-value skip-item" @click="skip2Domain">
                {{ colData.domainName }}
              </span>
            </el-form-item>
        ...
        <div class="prob-desc">
          <p class="part-title">{{ $t('domain.verification.problemDescription') }}</p>
          <datablau-form
            :model="colData"
            ref="form"
          >
            ...
            <el-form-item :label="$t('domain.verification.problemDescription')" class="safe-mask">
              <datablau-input
                size="mini"
                v-model="colData.problem"
                :placeholder="$t('domain.verification.problemDescriptionPlaceholder')"
                clearable
                type="textarea"
                row="3"
              ></datablau-input>
        ...
        <div class="prob-resolve">
          <p class="part-title">{{ $t('domain.verification.handlingSuggestion') }}</p>
          <datablau-form
            :model="colData"
            ref="form"
          >
            <el-form-item :label="$t('domain.verification.handlingSuggestion')" class="safe-mask">
              <datablau-input
                size="mini"
                v-model="colData.suggestion"
                :placeholder="$t('domain.verification.handlingSuggestionPlaceholder')"
                clearable
                type="textarea"
                row="3"
              ></datablau-input>
  ...
  methods: {
    ...
    confirm() {
      ...
      if (false) {
        ...
        this.$http
          .post(`${this.$url}/service/domains/updateVerifyInfo`, para)
          .then(res => {
