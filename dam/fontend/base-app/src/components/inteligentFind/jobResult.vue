<template>
  <div class="tab-page rec-job-result tab-page-ver2">
    ...
    <div class="table-row domain-detail" ref="tableLine" style="top:50px;">
      ...
      >
            ...
            <el-popover placement="top-start" trigger="hover">
              <div class="popover-con column-rec-dom">
                <el-form
                  ...
                  class="cloumn-detail"
                >
                  <el-form-item :label="`${$t('domain.common.owningSystem')}：`">
                    <span>
                      {{ modelCategoryMap[scope.row.modelCategoryId] }}
                    </span>
                  </el-form-item>
                  <el-form-item :label="`${$t('domain.common.owningDataSource')}：`">
        ...
        <el-table-column :label="$t('domain.dataFind.recommendedStandard')" prop="domains" :width="550">
          <template slot-scope="scope">
            <div
              class="container"
            ...
            >
              ...
              >
                <div class="popover-con rec-dom-con">
                  ...
                  >
                    ...
                    >
                      ...
                      <el-form-item :label="`${$t('domain.dataFind.businessDefinition')}：`">
                ...
                <el-button
                  ...
                  type="primary"
                  :class="{
                    'current-btn': recDomaMap[scope.row.objectId] === item.id,
                    'normal-btn': recDomaMap[scope.row.objectId] !== item.id,
                  }"
                  @click="handleChooseDom(scope, item)"
                  @mouseenter.native="
        ...
        >
          <template slot-scope="scope">
            <span>
              <datablau-button
                type="text"
                @click="handleBindDom(scope)"
                size="small"
              >
                {{ $t('domain.dataFind.accept') }}
              </datablau-button>
            </span>
            <span>
              <datablau-button
    ...
    <div class="row-page-info" style="width: 100%; padding-right: 20px">
      ...
      >
        {{ $t('domain.dataFind.bulkAcceptance') }}
      </datablau-button>
      <datablau-button
        v-if="$auth['INTELLIGENT_VIEW']"
        v-show="mutipleLength"
        ...
        :disabled="deleteDisabled"
      >
        {{ $t('domain.dataFind.bulkRejection') }}
      </datablau-button>
      <datablau-pagination
