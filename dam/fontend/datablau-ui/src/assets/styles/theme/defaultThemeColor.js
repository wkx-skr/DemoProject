...
const colorMap = {
  ...
  // 四级边框颜色 // 基本没有用
  '--border-color-extra-light': '#e5e5e5',
  ...
  '--white-grey-bgc': '#fff',
  '--menu-options-shadow': 'none',
  '--heading-shadow': '0 6px 10px 0px rgba(85, 85, 85, 0.08)',
  // 顶部导航栏 弹框
  // 顶部导航栏 弹框 背景色
  '--menu-options-color': '#484848',
  // 血缘图标签文本颜色
  '--lineage-label-color': '#494850',
  // 顶部导航栏 选中/hover 时 文本颜色
  '--menu-opt-item-color': '#c5c5c5',
  // 弹框内 单项 文本颜色
  '--left-hover-color': '#eaeaea',
  ...
  '--light-grey': '#fafafa',
  // loading 背景色
  '--loading-mask-bgc': 'rgba(255,255,255,0.9)',
