<template>
  <div
    class="tab-page cluster-result-tab tab-page-ver2"
    style="overflow: hidden; top: 10px"
  >
    ...
    <datablau-filter-row>
      <div class="row-inner ver-middle">
        <datablau-input
          :placeholder="$t('domain.domainCluster.searchDomainName')"
          v-model="keyword"
          :clearable="true"
          class="filter-input"
          :iconfont-state="true"
...
<script>
import clusterResult from './clusterResult.js'
