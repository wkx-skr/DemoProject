<template>
  <div
    class="data-source"
    :style="{
      left: appName !== 'DDD' ? '0px' : '-20px',
      right: appName !== 'DDD' ? '0px' : '-20px',
    }"
  >
    <el-dialog
    ...
    <datablau-page-title
      :parent-name="appName !== 'DDD' ? $t('common.page.dataResource') : ''"
      :name="appName !== 'DDD' ? $t('common.page.dataSource') : ''"
    ></datablau-page-title>
    <div
      class="citic-card-tabs"
      :style="{
        top: appName !== 'DDD' ? '40px' : '10px',
      }"
    >
      <el-tabs
        type="card"
