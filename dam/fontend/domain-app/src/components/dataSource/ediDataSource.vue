          ...
          >
            ...
            >
              <datablau-input
                ...
                size="mini"
                v-model.trim="dsform.displayName"
                :disabled="!dsEditing"
                maxlength="50"
                @keyup.native="toTrim"
            ...
            >
              <datablau-input
                ...
                size="mini"
                v-model.trim="dsform.displayNameAdd"
                maxlength="50"
                @keyup.native="toTrim"
                :placeholder="$t('meta.dataSource.edit.fillDataSourceName')"
              ></datablau-input>
            ...
            <div v-if="!isFileData">
              ...
              >
                ...
                <span
                  v-if="$versionFeature['metadata_Relationships']"
                  class="collect-item"
                >
            ...
            <div v-if="!isFileData">
              ...
              <el-form-item
                v-if="$versionFeature['meta.dataSource.edit.dataSampling']"
                :label="$t('meta.dataSource.edit.dataSampling')"
              >
                <el-radio-group
