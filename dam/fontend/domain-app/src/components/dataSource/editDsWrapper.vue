      ...
      <div class="form-container">
        ...
        >
          ...
          <div
            ...
            v-if="dataSourceType !== 'report' && dataSourceType !== 'SQL'"
          >
            <el-form-item
              v-if="dsEditing"
          ...
          <div
            class="database-info-container"
            v-else-if="!isAgent && dataSourceType !== 'SQL'"
          >
            <report-ds
              ref="reportDs"
...
<script>
'use strict'
import js from './editDsWrapper.js'
