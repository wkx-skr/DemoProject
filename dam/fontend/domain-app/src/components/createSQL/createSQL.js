  ...
  methods: {
    ...
    loadTables(callback) {
      if (this.modelFromDam) {
        ...
        this.$http
          .post(this.$url + '/service/entities/search', json)
          .then(res => {
    ...
    loadModelsFromDDM(callback) {
      this.$http
        .get(this.$url + '/service/models/ddm/models')
        .then(res => {
          const map = {}
    ...
    loadTablesFromDDM(callabck, modleId) {
      this.$http
        .get(this.$url + '/service/models/ddm/models/' + modleId + '/tables')
        .then(res => {
          if (res.data && Array.isArray(res.data)) {
            callabck && callabck(res.data)
          }
