    ...
    >
      <div id="nav-btn-box">
        <el-menu
          ...
          :unique-opened="false"
          :router="true"
          :collapse="!$store.state.isNavExtension"
          @open="handleOpen"
          @select="handleSelect"
          @close="handleClose"
          v-if="showNav"
        ...
        >
          ...
          >
            ...
            <el-menu-item
              v-if="menuMap['logAudit']"
              index="/main/gateway/logAudit"
            >
              <span slot="title" class="menu-margin-left">
                {{ $t('common.page.logAudit') }}
              </span>
            </el-menu-item>
            <!-- <el-menu-item
      ...
      <div id="ext-btn" @click="toggleExtension">
        <i v-if="!$store.state.isNavExtension" class="fa fa-angle-double-right"></i>
