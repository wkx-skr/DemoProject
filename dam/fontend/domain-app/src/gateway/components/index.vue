<template>
  <div class="gateway-page">
    <datablau-dialog
      ...
      size="l"
      :height="form.gatewayType === 'DATAMASKING_GATEWAY' ? 570 : 425"
      :hasBorder="true"
    >
      <el-form
        :model="form"
      ...
      >
        ...
        <el-form-item
          v-if="form.custom && form.gatewayType !== 'PROXY_GATEWAY'"
          label="用户名"
    ...
    <datablau-dialog
      ...
      :close-on-click-modal="false"
      size="l"
      :height="form.gatewayType === 'DATAMASKING_GATEWAY' ? 520 : 425"
    >
      <el-form
        :model="editForm"
        ref="editForm"
      ...
      >
        ...
        <el-form-item label="数据源：" prop="modelName">
        ...
        <el-form-item
          v-if="editForm.custom && editForm.gatewayType !== 'PROXY_GATEWAY'"
          label="用户名"
          prop="serviceUsername"
          :rules="[{ required: true, message: '用户名不能为空' }]"
        >
        ...
        <el-table-column prop="code" label="网关组编码">
          <template slot-scope="scope">
            <datablau-input
              ...
              :disabled="scope.row.edit || scope.row.id"
              clearable
    ...
    >
      <datablau-table :data="curStatusData">
        <el-table-column prop="name" label="网关组"></el-table-column>
