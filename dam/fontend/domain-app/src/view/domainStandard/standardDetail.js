...
import Validator from "@/view/newDataStandard/validator/standard";
...
export default {
  ...
  data() {
    ...
    return {
      ...
      state: null,
      rules: {
        domainCode: Validator.domainCode({categoryId: this.categoryTypeId, elThis: this}),
        chineseName: Validator.chineseName({categoryId: this.categoryTypeId, elThis: this}),
        englishName: [
          {
            required: true,
            trigger: 'blur',
