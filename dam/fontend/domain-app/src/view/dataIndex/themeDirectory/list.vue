<template>
  <div class="list-box">
    ...
    >
      ...
      <!-- <div class="dialog-container" v-if="folderVisible">
        <el-form
          class="page-form"
          label-width="80px"
          :rules="rules"
      ...
      <span slot="footer" class="dialog-footer">
        <datablau-button @click="addfolder" type="important">
          确定
        </datablau-button>
        <datablau-button @click="close">取消</datablau-button>
      </span> -->
    </datablau-dialog>
    <div class="top-row">
      <!-- <datablau-page-title
    ...
    <div class="second-row-info">
      <p @click="handleAllShow" :class="{ 'is-active': isAllActive }">
        ...
        <span>{{ $t('indicator.subject.allCategory') }}</span>
      </p>
    </div>
    <div
      v-if="noCategory"
