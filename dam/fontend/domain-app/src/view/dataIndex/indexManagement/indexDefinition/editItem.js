  ...
  methods: {
    ...
    processCreate(requestBody, closeAfterSuccess) {
      this.$http
        .post(
          requestBody.state === 'D'
            ? `${this.$domain_url}/domains/domain/updateDomain`
            : `${this.$domain_url}/domains/domain/createDomain`,
          requestBody
        )
        .then(res => {
