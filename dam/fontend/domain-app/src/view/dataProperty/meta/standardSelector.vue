...
export default {
  ...
  mounted() {
    ...
    if ([2, 5].includes(this.categoryTypeId)) {
      ...
      this.keywordPlaceholder = this.$t('domain.domainStandard.searchIndex')
  ...
  methods: {
    ...
    innerLoadStandardTree() {
      ...
      return new Promise(resolve => {
        ...
        this.$http
          // .post(this.$url + '/service/domains/tree/getTree ', obj)
          .post('/domain/domains/tree/getTree/uncheckRole', obj)
    ...
    innerLoadStandard() {
      ...
      this.$http
        .post(
          `/domain/domains/domain/getPublicPage/uncheckRole${
            this.domainState ? '?state=' + this.domainState : ''
          }`,
          obj
        )
