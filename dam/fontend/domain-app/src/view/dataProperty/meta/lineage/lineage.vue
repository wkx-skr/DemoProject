...
export default {
  ...
  methods: {
    ...
    bindLineage() {
      this.$http
        .post(this.$url + `/service/entities/view/${this.objectId}/tables/bind`)
        .then(res => {
    ...
    unbindSp() {
      this.$http
        .post(this.$url + '/service/lineage/unbind/sp', this.lineageData)
        .then(res => {
    ...
    checkIfBound() {
      this.$http
        .get(this.$url + `/service/entities/view/${this.objectId}/tables/bound`)
        .then(res => {
          this.bound = res.data
        })
        .catch(e => {
    ...
    analysize() {
      this.$http
        .post(
          this.$url + `/service/entities/view/${this.objectId}/tables/analysis`
        )
        .then(res => {
    ...
    getData() {
      ...
      if (type === 'REPORT') {
        ...
        const url = `${this.$url}/service/lineage/object/${this.data.objectId}/type?type=${type}`
