      ...
      <div class="tabs-outer table-lineage-info">
        <el-tabs v-model="activeName">
          ...
          >
            ...
            >
              <span class="info-tooltip lineage-problem-title">
                <datablau-tooltip
...
export default {
  ...
  methods: {
    ...
    dataInit() {
      ...
      if (String(this.objectId).startsWith('report')) {
        return
      }
      this.loading = true
    ...
    downloadLineage(type) {
      ...
      let url = `${this.$url}/service/lineage/object/${this.objectId}/download/${type}`
