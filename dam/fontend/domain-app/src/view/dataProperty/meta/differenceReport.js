...
export default {
  ...
  methods: {
    ...
    getSyncHistoryList() {
      this.syncTimeArr = []
      this.$http
        .get(this.$url + `/service/models/sync/history/${this.currentMapping}`)
        .then(res => {
          if (!res.data) {
            this.syncTimeArr = []
            this.syncTime = ''
    ...
    getDataSync(value) {
      ...
      this.$http
        .get(
          this.$url +
            `/service/models/sync/history/${this.currentMapping}/${value}`
        )
        .then(res => {
    ...
    getVersions(id, modelId, versionName) {
      ...
      this.$http
        .get(this.$url + `/service/models/ddm/models/${id}/versions`)
        .then(res => {
    ...
    getSchemas() {
      this.$http
        .get(this.$url + `/service/models/${this.modelId}/schemas`)
        .then(res => {
    ...
    getCompareMappings() {
      this.showTree = false
      this.$http
        .get(this.$url + `/service/models/${this.modelId}/compareMappings`)
        .then(res => {
    ...
    deleteCompareMapping(mapping, $event) {
      ...
      this.$http
        .delete(
          this.$url +
            `/service/models/binding/${mapping.damModelId}/ddm/model/${mapping.id}`
        )
        .then(res => {
    ...
    saveCompareMapping() {
      ...
      this.$http
        .post(
          this.$url + '/service/models/binding/ddm/model',
          compareMappingBody
        )
        .then(res => {
    ...
    getHistory(mapping) {
      ...
      this.$http
        .get(
          this.$url +
            `/service/models/${this.modelId}/${mappingId}/compareResultHistory`
        )
        .then(res => {
          this.histories = []
    ...
    getBindedModels() {
      if (this.targetDdmModelId) {
        ...
        this.$http
          .get(this.$url + '/service/models/' + this.modelId + '/plain')
          .then(res => {
