  ...
  <div style="height: 100%" id="ddd" class="domain-component-outer">
    ...
    >
      ...
      >
        <div
          class="elRadioSelect"
          :style="`height: ${this.$i18n.locale === 'zh' ? '90px' : '120px'}`"
    ...
    <datablau-dialog
      ...
      width="500px"
      height="316px"
      :title="`${$t('domain.domain.addCategory', {
        typeName: labelText.typeName,
      })}`"
    ...
    >
      <div class="updateDiv">
        ...
        >
          ...
          <el-form-item
            :label="$t('domain.domain.bizCode')"
            v-if="addObj.parentId === 1"
            prop="bizCode"
          >
            <datablau-input
              clearable
      ...
      <div slot="footer">
        ...
        <datablau-button type="important" @click="addSubmit">
          {{ $t('common.button.ok') }}
        </datablau-button>
    ...
    >
      ...
      <div slot="footer">
        <datablau-button type="primary" size="mini" @click="changeSubmit">
          {{ $t('common.button.ok') }}
        </datablau-button>
    ...
    >
      ...
      />
      <div slot="footer">
        <datablau-button type="primary" size="mini" @click="toMove">
          {{ $t('common.button.ok') }}
        </datablau-button>
        <datablau-button
          type="secondary"
          size="mini"
          @click="moveDomainDialog = false"
        >
          {{ $t('common.button.cancel') }}
        </datablau-button>
      </div>
    ...
    <div class="content-area">
      <div class="folder-content-box">
        <folder-detail
          ...
          @add="add"
          @clickMoveBtn="moveDomainDialog = true"
        ></folder-detail>
      </div>
    </div>
    <div
    ...
    ></edit-dim>
    <div class="ruleManageBox" v-if="ruleManage">
      <data-ruleManage
        @closeRuleManage="closeRuleManage"
        @openDialogDomainRule="openDialogDomainRule"
        ref="dataruleManage"
      ></data-ruleManage>
    </div>
    <datablau-dialog
      title="新建规则"
      size="m"
      :visible.sync="dialogDomainRuleVisible"
    >
      <div>
        <datablau-form
          label-width="100px"
          :model="domainRuleForm"
          :rules="domainRuleRules"
          ref="domainRuleRules"
        >
          <el-form-item label="规则名称" prop="name">
            <datablau-input
              v-model="domainRuleForm.name"
              maxlength="50"
              class="maxlengthInput"
              show-word-limit
            ></datablau-input>
          </el-form-item>
          <el-form-item label="规则类型" prop="techRuleType">
            <!-- <el-cascader
              style="width: 300px"
              :options="classOptions"
              @active-item-change="handleActiveClassOptions"
              @change="handleChangeClassOptions"
              v-model="domainRuleForm.techRuleType"
          ...
          <el-form-item label="规则内容" prop="content">
            <datablau-input
              ...
              v-model="domainRuleForm.content"
          ...
          <el-form-item label="描述">
            <datablau-input
              ...
              style="width: 500px"
              :autosize="{ minRows: 3, maxRows: 3 }"
              v-model="domainRuleForm.description"
              class="maxlengthInput"
              maxlength="500"
              show-word-limit
            ></datablau-input>
      ...
      <div slot="footer">
        <datablau-button type="primary" @click="createDomainRule">
          {{ $t('common.button.ok') }}
        </datablau-button>
        <datablau-button type="secondary" @click="closeDialogDomainRule">
          {{ $t('common.button.cancel') }}
        </datablau-button>
      </div>
    </datablau-dialog>
