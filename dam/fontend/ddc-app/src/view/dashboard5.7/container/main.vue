<template>
  <div class="container" :style="{ backgroundColor: BACKGROUND_COLOR }">
    <div class="forPdf">
      ...
      <datablau-dialog
        :title="$t('common.dashboard.componentsDialogTitle')"
        width="940px"
      ...
      >
        <datablau-transfer
          ...
          :titles="[
            $t('common.dashboard.canSelect'),
            $t('common.dashboard.added'),
          ]"
          :button-texts="[
            $t('common.dashboard.move'),
            $t('common.dashboard.add'),
          ]"
          :filter-placeholder="$t('common.dashboard.filterPlaceholder')"
      ...
      >
        ...
        >退出编辑模式</el-button>-->
          ...
          >
            {{
              proMode
                ? $t('common.dashboard.folded')
                : $t('common.dashboard.expand')
            }}
          </datablau-button>
          <template v-if="editMode && proMode">
            {{ $t('common.dashboard.columnGrids') }}
            <el-input-number
              size="mini"
              :min="3"
              :max="gridsNum"
          ...
          <el-input-number
            ...
            style="margin-right: 10px;"
          ></el-input-number>-->
            {{ $t('common.dashboard.heightReference') }}
            <el-input-number
              v-model="HEIGHT_BASE"
              :min="min"
              :max="200"
              ...
              size="mini"
            ></el-input-number>
            {{ $t('common.dashboard.componentSpacing') }}
            <el-input-number
