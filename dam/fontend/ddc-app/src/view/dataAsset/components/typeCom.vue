  ...
  <div>
    ...
    >
      ...
      <datablau-upload
        :isEdit="true"
        :drag="true"
        :action="`${$assets_Url}/config/upload`"
        :limitNum="1"
        :multiple="false"
        :file-list="fileList"
...
<script>
import level1 from '@/assets/images/dataAssets/level1.png'
import level2 from '@/assets/images/dataAssets/leve2.png'
import level3 from '@/assets/images/dataAssets/leve3.png'
import level4 from '@/assets/images/dataAssets/leve4.png'
import level5 from '@/assets/images/dataAssets/leve5.png'
import level0 from '@/assets/images/dataAssets/leve0.png'
