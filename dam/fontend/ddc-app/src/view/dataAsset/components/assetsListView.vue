    ...
    <div class="middle-tag-box">
      ...
      >
          ...
          >
            ...
            >
              <el-checkbox
                ...
                :key="s.tagId"
                :label="s"
                @change="bool => handleTagCheckboxChange(bool, s)"
              >
        ...
        <!-- <el-popover
          ...
          :open-delay="500"
        >
          <div style="display: flex; padding: 20px; line-height: 2em">
            <div
      ...
      <datablau-form-submit>
        <div class="assets-item-box">
          ...
          >
            ...
            <div class="brief-box">
              <div class="item-name">
                <is-show-tooltip :content="item.tableName">
                  <datablau-high-light
              ...
              <div class="attr-box">
                ...
                >
                  ...
                  />
                  <span style="margin-left: 6px; font-weight: 500">
                    {{ $t('assets.assetList.directoryManager') }}：
                  </span>
                  <span class="span-tooltip">
                    <is-show-tooltip
                ...
                >
                  ...
                  />
                  <span style="margin-left: 6px; font-weight: 500">
                    {{ $t('assets.assetList.directoryRoute') }}：
                  </span>
                  <span class="span-tooltip">
                    <is-show-tooltip
