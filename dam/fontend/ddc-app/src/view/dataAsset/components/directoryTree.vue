...
<template>
  ...
  >
        ...
        >
                  ...
                  <div style="overflow: hidden; max-width: 560px">
                    ...
                    >
                      <el-tooltip placement="top">
                        <div slot="content">
                          {{ $t('assets.directoryTree.noCatalogPower') }}
                        </div>
                        <i class="el-icon-lock" style="margin-right: 0"></i>
                      </el-tooltip>
                    </span>
                  </div>
                </el-dropdown-item>
          ...
          >
            <i
              ...
              @click="$bus.$emit('changeStructure')"
            ></i>
          </datablau-tooltip>
        </div>
      </template>
    ...
    <datablau-dialog
      :title="$t('assets.directoryTree.deleteCatalogTip')"
      width="400px"
    ...
    >
      <div style="font-size: 16px; color: #606266">
        ...
        ></i>
        {{ $t('assets.directoryTree.deleteTip', { name: operateNode.name }) }}
      </div>
    ...
    <datablau-dialog
      :title="$t('assets.directoryTree.moveTip')"
    ...
    >
      <datablau-easy-tree
        ...
        :defaultCheckedKeys="selectedTargetDir ? [selectedTargetDir.id] : []"
        :default-expand-all="false"
        :expand-on-click-node="false"
        check-on-click-node
        :data-img-function="dataImgFunction"
