              ...
              >
                <template slot-scope="scope">
                 ...
                 <!-- <div
                  ...
                  <div v-else class="meta-data field1">
...
import { methodRuleType } from '@/view/dataAsset/utils/util.js'
