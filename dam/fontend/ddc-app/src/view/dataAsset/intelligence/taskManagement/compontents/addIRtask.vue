<template>
  <div id="data-masking-rule">
    ...
    <div class="content-box" v-loading="saveLoading">
      <datablau-form-submit>
        ...
        >
          ...
          <el-form-item label="schema" prop="elementObjectId" v-if="schemaShow">
            <datablau-select
              filterable
              clearable
              style="width: 500px; display: inline-block"
          ...
          <el-form-item :label="$t('intelligence.runTime1')">
            <datablau-radio v-model="timeType" ref="radio">
              <el-radio
                label="select"
          ...
          >
            ...
            >
              <template slot-scope="scope">
                ...
                <div
                  v-else-if="scope.row.discernRange === 'FILE'"
                  class="meta-data domain"
                >
                  {{ $t('assets.generalSettings.file') }}
                </div>
                <div
                  v-else-if="scope.row.discernRange === 'REPORT'"
                  class="meta-data report"
                >
                  {{ $t('assets.generalSettings.report') }}
                </div>
            ...
            >
              <template slot-scope="scope">
                <datablau-button
                  v-if="$auth.DATA_ASSET_DISCERN_ALGORITHM_MANAGE"
...
.maxlength-input .el-input input{
  padding-right: 65px;
}
</style>
