          ...
          <datablau-list-search style="padding: 10px 20px">
            ...
            <template slot="buttons">
              <datablau-button
                ...
                "
                :disabled="catalogLen === 0 || !$auth.IDENTIFY_TASK_MANAGE"
              >
          ...
          <div class="table-box">
            <datablau-form-submit>
              ...
              >
                ...
                <el-table-column
                  prop="modelName"
                  :label="$t('securityModule.collectionName')"
                  min-width="120"
                  show-overflow-tooltip
                >
                ...
                ></el-table-column>
                <el-table-column
                  v-if="$auth.IDENTIFY_TASK_MANAGE"
                  ...
                  <template slot-scope="scope">
                    ...
                    >
                      <datablau-switch
                        ...
                        :disabled="!$auth.IDENTIFY_TASK_MANAGE"
                    ...
                    <datablau-button
                      ...
                      :disabled="!$auth.IDENTIFY_TASK_MANAGE || scope.row.status === 'RUNNING' || scope.row.status === 'INIT' ||
                    ...
                    <datablau-button
                      ...
                      :disabled="!scope.row.enabled || judgeMachine(scope.row) || !$auth.IDENTIFY_TASK_MANAGE"
                      v-if="
                        scope.row.status !== 'RUNNING' &&
                        scope.row.status !== 'INIT' &&
                        scope.row.status !== 'CREATED'
...
import { methodRuleType, delObjMethod } from '@/view/dataAsset/utils/util.js'
...
export default {
  ...
  methods: {
    ...
    changeStatus(obj) {
      if(!this.$auth.IDENTIFY_TASK_MANAGE) return
