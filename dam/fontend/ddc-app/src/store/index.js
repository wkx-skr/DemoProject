...
export default new Vuex.Store({
  ...
  mutations: {
    ...
    changeShowStaffTree(state, value) {
      state.showStaffTree = value
    },
    ...
    changeBranchIsLazy(state, value) {
      state.branchIsLazy = value
    },
    ...
    setShowAssetAlgorithm(state, value) {
      state.showAssetAlgorithm = value
    },
  },
  modules: {
    leftNav,
