<template>
  <div class="box top-right-corner-vue" :class="{ dark }">
    <div
      style="
    ...
    <datablau-switch
      v-if="$store && $store.state && $store.state.isDevOrTest"
      active-text="en"
      inactive-text="中"
      active-value="en"
      inactive-value="zh"
      ...
      >
        <div style="padding-left: 12px">
          ...
          >
            ...
            <el-tab-pane label="其他任务" name="other"></el-tab-pane>
          </datablau-tabs>
          <div
            style="
              width: 100%;
    ...
    >
      <span class="el-dropdown-link">
        <div
          class="user"
          :class="{
            'is-ddc-home': $store && $store.state && $store.state.isDdcHome,
          }"
        >
          <div class="portrait">
