<template>
  ...
  >
    ...
    <div :class="{ lineageTab: lineageTab }">
      <div id="breadCrum" v-if="!isAdd">
        ...
        <datablau-form style="padding-top: 20px" label-width="120px">
          ...
          <div>
            <el-form-item>
              <el-col :span="2" style="padding-right: 10px; width: 94px">
    ...
    <div
      ...
      :class="{ 'job-detail-buttons2': lineageTab }"
    >
      <div class="btn-outer">
        <datablau-button
          size="small"
        ...
        <!--        <div v-else>
          <datablau-button
            v-if="
              !jobDetails.jobContent.logical &&
              jobDetails.jobContent.logical === false &&
              (jobDetails.type === 'MetadataSyncJobDescriptor' ||
                jobDetails.jobType === 'MetadataSyncJobDescriptor')
            "
            type="important"
          ...
          <datablau-button
            ...
            :disabled="
              (showTestBtn &&
                ...
                this.job.type === 'LoadLineageJobDescriptor') ||
              !paramsValidation ||
              (jobtype === 'ClusterColumnJobDescriptor' && jobLoading)
            "
          >
            {{ $t('common.button.save') }}
          </datablau-button>
