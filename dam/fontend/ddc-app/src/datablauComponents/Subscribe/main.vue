<template>
  ...
  >
    ...
    <i class="iconfont icon-dingyue ed" :title="$t('domain.common.cancelSubscribe')" v-if="ed"></i>
    <i class="iconfont icon-dingyue" :title="$t('domain.common.subscription')" v-else></i>
  </datablau-button>
  <datablau-button
