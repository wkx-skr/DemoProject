...
import DatablauHighLight from '@/next/components/basic/highLight/DatablauHighLight.vue'
import DatablauEasyTree from '@/next/components/basic/easyTree/DatablauEasyTree.vue'
import DatablauTreeHeader from '@/next/components/basic/treeHeader/treeHeader.vue'
import DatablauSkeleton from '@/next/components/basic/skeleton/index.vue'
import DatablauSkeletonItem from '@/next/components/basic/skeleton/item.vue'
const components = [
  DatablauButton,
  DatablauInput,
  DatablauRadio,
