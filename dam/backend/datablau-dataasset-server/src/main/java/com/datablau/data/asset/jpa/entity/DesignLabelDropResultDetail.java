...
@Entity
@Table(
        name = "design_label_drop_result_detail"
)
public class DesignLabelDropResultDetail {


    @Id
    @Column(name = "id")
    @GeneratedValue(
            generator = "design_label_drop_result_detail_generator"
    )
    @GenericGenerator(
            name = "design_label_drop_result_detail",
            ...
            parameters = {@org.hibernate.annotations.Parameter(
                    name = "sequence_name",
                    value = "DESIGN_LABEL_DROP_RESULT_DETAIL_SEQ"
            )}
    )
    private Long id;
    /**
    ...
    public DesignLabelDropResultDetail() {
    }

    public DesignLabelDropResultDetail(DesignLabelDropResultDetailDto designLabelDropResultDetailDto) {
