...
@Entity
@Table(
        name = "design_label_drop_result"
)
public class DesignLabelDropResult {


    @Id
    @Column(name = "id")
    @GeneratedValue(
            generator = "design_label_drop_result_generator"
    )
    @GenericGenerator(
            name = "design_label_drop_result_generator",
            strategy = "com.datablau.data.common.jpa.util.DatablauIdGenerator",
            parameters = {@org.hibernate.annotations.Parameter(
                    name = "sequence_name",
                    value = "DESIGN_LABEL_DROP_RESULT_SEQ"
            )}
    )
    private Long id;
    ...
    public DesignLabelDropResult() {
    }

    public DesignLabelDropResult(DesignLabelDropResultDto designLabelDropResultDto) {
