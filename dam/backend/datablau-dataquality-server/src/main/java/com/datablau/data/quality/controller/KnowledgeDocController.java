...
public class KnowledgeDocController extends BaseController {
    ...
    public KnowledgeDocController(@Autowired RoleService roleService) {
...
//            systemModule = OperationModuleType.QUALITY_KNOWLEDGE,
//            description = "查询知识库"
//    )
