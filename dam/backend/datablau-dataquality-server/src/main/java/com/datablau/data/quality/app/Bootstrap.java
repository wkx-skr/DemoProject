...
import com.datablau.data.quality.bean.PerformanceMonitorUtility;
import com.datablau.data.quality.config.InterceptorConfiguration;
import com.datablau.data.quality.config.NacosConfig;
import com.datablau.data.quality.config.RegisterNacosServer;
import com.datablau.data.quality.config.SecurityBeanConfiguration;
import com.datablau.data.quality.job.DataQualityJobExecutor;
import com.datablau.data.quality.mq.KafkaConsumer;
...
public class Bootstrap implements CommandLineRunner {
    ...
    public static void main(String[] args) {
        DataQualityConstant.INIT_FROM_BOOSTRAP = true;
        initProperties();
    ...
    public void run(String... args) throws Exception {
        runner = new DataQualityJobExecutor(null, queueName, topicName, null);
    ...
    public static void initProperties(){
        ...
        System.setProperty("datablau.job.jar.register.enable", "false");
        try {
            DataQualityApp.extractFilesToPath("classpath:/resources/**", "resources");
        } catch (Exception e) {
