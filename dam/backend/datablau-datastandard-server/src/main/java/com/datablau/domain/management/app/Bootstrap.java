package com.datablau.domain.management.app;

import com.alibaba.cloud.nacos.registry.NacosServiceRegistryAutoConfiguration;
import com.andorj.model.common.api.impl.MessageServiceImpl;
import com.datablau.domain.management.config.HttpExporterConfiguration;
import com.datablau.domain.management.config.NacosConfig;
import com.datablau.domain.management.config.RegisterNacosServer;
import com.datablau.domain.management.config.SecurityBeanConfiguration;
import com.datablau.domain.management.config.SwaggerOpenApiResource;
import com.datablau.domain.management.job.impl.DomainJobExecutor;
import com.datablau.domain.management.mq.KafkaConsumer;
...
@SpringBootApplication(
    scanBasePackages = {"com.datablau.domain"},
    exclude = {
...
public class Bootstrap implements CommandLineRunner {
    ...
    public void run(String... args) throws Exception {
        runner = new DomainJobExecutor(null, queueName, topicName, null);
