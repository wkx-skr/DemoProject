...
import com.datablau.domain.management.type.DatablauServerType;
...
public class BaseController {
    ...
    public void checkPermission(HttpServletRequest request) {
        BaseControllerUtil.checkPermission(RemoteServiceGetter.getRoleService(), DatablauServerType.Domain.name(), request);
    }
    ...
    public ErrorDto accessError(HttpServletResponse response, AccessDeniedException le) {
        ...
        ErrorDto error = new ErrorDto();
        error.setErrorMessage(GeneralUtility.getMessageService().getMessage("doNotHaveEnoughPermission"));
