package com.datablau.security.management.app;
...
@SpringBootApplication(
        scanBasePackages = {"com.datablau.security","com.datablau.model.message.config"},
        exclude = {
...
public class UserMgmtApplication extends SpringBootServletInitializer {
    ...
    public static void main(String[] args) throws Exception {
        if (Strings.isNullOrEmpty(System.getProperty("logging.file.path"))) {
            String rootFolder = ShareKit.getCurrentServicePath(UserMgmtApplication.class);
            System.setProperty("logging.file.path", rootFolder + "logs");
        }

        extractFilesToPath("classpath:/resources/**", "resources");
        SpringApplication.run(UserMgmtApplication.class);
    }

    private static void extractFilesToPath(String classPathFolder, String targetFolder) throws Exception {
        URL baseUrl = UserMgmtApplication.class.getProtectionDomain().getCodeSource().getLocation();
        ...
        PathMatchingResourcePatternResolver resolver = new PathMatchingResourcePatternResolver(UserMgmtApplication.class.getClassLoader());
