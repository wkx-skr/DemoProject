...
public class SyncEtlLineageJobHandler implements JobDescriptorHandler {

    public static final SyncEtlLineageJobWrapper SYNC_ETL_LINEAGE_JOB_WRAPPER = new SyncEtlLineageJobWrapper();
    ...
    public DatablauJobDescriptor getTemplate() {
        ...
        descriptor.setName(SYNC_ETL_LINEAGE_JOB_WRAPPER.getName());
        descriptor.setEndVersion(JobDescriptorAdapter.getCurrentVersion());
        descriptor.setTypeName(SYNC_ETL_LINEAGE_JOB_WRAPPER.getTypeName());
        return descriptor;
    }
    ...
    public boolean canHandle(String jobType) {
        return SYNC_ETL_LINEAGE_JOB_WRAPPER.getTypeName().equals(jobType);
    }
}
