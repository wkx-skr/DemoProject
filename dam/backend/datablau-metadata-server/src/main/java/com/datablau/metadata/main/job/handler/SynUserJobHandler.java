...
public class SynUserJobHandler implements JobDescriptorHandler {

    public static final SynUserJobWrapper SYNC_JOB_WRAPPER = new SynUserJobWrapper();

    public SynUserJobHandler() {
    }
