...
public class SyncUnstructuredDirectoryJobHandler implements JobDescriptorHandler {

    public static final SyncUnstructuredDirectoryJobWrapper SYNC_UNSTRUCTURED_DIRECTORY_JOB_WRAPPER = new SyncUnstructuredDirectoryJobWrapper();
    ...
    public DatablauJobDescriptor getTemplate() {
        ...
        descriptor.setName(SYNC_UNSTRUCTURED_DIRECTORY_JOB_WRAPPER.getName());
        descriptor.setEndVersion(JobDescriptorAdapter.getCurrentVersion());
        descriptor.setTypeName(SYNC_UNSTRUCTURED_DIRECTORY_JOB_WRAPPER.getTypeName());
        return descriptor;
    }
    ...
    public boolean canHandle(String jobType) {
        return SYNC_UNSTRUCTURED_DIRECTORY_JOB_WRAPPER.getTypeName().equals(jobType);
    }
}
